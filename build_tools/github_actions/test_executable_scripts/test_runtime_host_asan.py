    ...
    "rocshmem": (
        {
            ...
            "count": 79,
            "sha256": "5f517cf84a42fca8000429fbf5a7826bcb089ae8e5e67f070103428d49f29e4e",
        },
    ),
    "rocrtst": (
        {
            ...
            "count": 9,
            "sha256": "427e22cbc625d6c60ae4a6707dbbcbdaf2ad49b54bc788a03e1b52f5b505bf36",
        },
        {
            "path": "bin/rocrtst_poll_backoff_test",
            "count": 5,
            "sha256": "5d850b2b916442ce4f45ea65c41ecf7a98a2b489fc9dbd254e960f0a90dd3d04",
        },
        {
            "path": "bin/rocrtst_doorbell_type_test",
            "count": 13,
            "sha256": "f138745c36bd5cd39ce4b089c253c5ab677bcfeeb40fdda9f543169ef0face3d",
        },
    ),
}
...
def _require_direct_asan(executable: Path, env: dict[str, str]) -> None:
    ...
    if not _ASAN_NEEDED_RE.search(result.stdout):
        raise RuntimeError(f"executable is not directly linked to Clang ASAN: {executable}")
