        ...
        with redshift_connector.connect(
            ...
            with conn.cursor() as cursor:
                ...
                for i in range(len(input_dict["jobs"])):
                    ...
                    'Linux (linux-mi325-1gpu-ossci-rocm-test, gfx94X-dcgpu, gfx942) / Build / Build Linux Packages (xfail false)'
                    ...
                    if "gfx" in platform_str:
                        # Extract first group to filter out GPUs from platform_str Linux (linux-mi325-1gpu-ossci-rocm-test, gfx94X-dcgpu, gfx942) / Build / Build Linux Packages (xfail false) into list [gfx94X-dcgpu, gfx942]
