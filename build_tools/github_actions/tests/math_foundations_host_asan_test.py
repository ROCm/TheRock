...
class MathFoundationsHostAsanTest(unittest.TestCase):
    ...
    def test_rocroller_requires_direct_asan_and_drops_inherited_preload(self):
        script = SCRIPT_DIR / "test_rocroller.py"
        with (
            patch.dict(
                os.environ,
                {
