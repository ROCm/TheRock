...
"""Unit tests for publish_uccl_to_release_bucket.py."""
...
from github_actions.publish_uccl_to_release_bucket import main


class TestPublishUcclToReleaseBucket(unittest.TestCase):
    def setUp(self):
    ...
    @mock.patch("github_actions.publish_uccl_to_release_bucket.gha_set_output")
    def test_dev_uploads_to_multi_arch_index(self, mock_set_output, mock_upload):
        ...
        self.assertEqual(mock_upload.call_args.kwargs["include"], ["uccl-*.whl"])
    ...
    @mock.patch("_therock_utils.storage_backend.S3StorageBackend.upload_directory")
    def test_fails_when_no_uccl_wheel_is_uploaded(self, mock_upload):
