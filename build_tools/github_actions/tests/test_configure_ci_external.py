...
class TestAutoDetectConfiguration(unittest.TestCase):
    ...
    def test_rocm_libraries_variables(self):
        ...
        self.assertEqual(
            expected_vars["cmake_source_var"], "THEROCK_ROCM_LIBRARIES_SOURCE_DIR"
        )
        self.assertEqual(expected_vars["patches_dir"], "rocm-libraries")
        self.assertEqual(
            expected_vars["fetch_exclusion"], "--no-include-rocm-libraries"
        )
    ...
    def test_rocm_systems_variables(self):
        ...
        # Verify each expected variable
        self.assertEqual(
            expected_vars["cmake_source_var"], "THEROCK_ROCM_SYSTEMS_SOURCE_DIR"
        )
