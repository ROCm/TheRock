...
python build_tools/install_rocm_from_artifacts.py
    ...
    [--rand | --no-rand] [--rccl | --no-rccl] [--rocwmma | --no-rocwmma] [--tests | --no-tests] [--base-only]
...
def retrieve_artifacts_by_run_id(args):
    ...
    if args.base_only:
        ...
        [args.blas, args.fft, args.hipdnn, args.miopen, args.prim, args.rand, args.rccl, args.rocwmma]
    ):
        argv.extend(base_artifact_patterns)
