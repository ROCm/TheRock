...
class LibraryEntry:
    ...
    def __init__(
        self, shortname: str, package_name: str, so_pattern: str, dll_pattern: str, posix_relpath = "lib"
    ):
...
LibraryEntry("rocm_sysdeps_liblzma", "core", "librocm_sysdeps_liblzma.so.*", "", "lib/rocm_sysdeps/lib")
