...
| AMD RX 7900 XTX                    | gfx1100    | gfx110-all | [rocm](#rocm-for-gfx110-all) // [torch](#torch-for-gfx110-all) |
| AMD RX 7800 XT                     | gfx1101    | gfx110-all | [rocm](#rocm-for-gfx110-all) // [torch](#torch-for-gfx110-all) |
| AMD RX 7700S / Framework Laptop 16 | gfx1102    | gfx110-all | [rocm](#rocm-for-gfx110-all) // [torch](#torch-for-gfx110-all) |
| AMD Radeon 780M Laptop iGPU        | gfx1103    | gfx110-all | [rocm](#rocm-for-gfx110-all) // [torch](#torch-for-gfx110-all) |
...
```bash
python -m pip install \
  --index-url https://rocm.nightlies.amd.com/v2/gfx110-all/ \
  "rocm[libraries,devel]"
```
...
# rocm-sdk-libraries-gfx110-all==6.5.0rc20250610
```
...
# For example...
wget https://therock-nightly-tarball.s3.us-east-2.amazonaws.com/therock-dist-linux-gfx110-all-6.5.0rc20250610.tar.gz
...
- Downloads the version `6.4.0rc20250516` gfx110X artifacts from GitHub release tag `nightly-tarball` to the specified output directory `build`:
  ...
  ```bash
  python build_tools/install_rocm_from_artifacts.py --release 6.4.0rc20250516 --amdgpu-family gfx110-all --output-dir build
  ```
...
- Downloads the version `6.4.0.dev0+e015c807437eaf32dac6c14a9c4f752770c51b14` gfx110X artifacts from GitHub release tag `dev-tarball` to the default output directory `therock-build`:
  ...
  ```bash
  python build_tools/install_rocm_from_artifacts.py --release 6.4.0.dev0+e015c807437eaf32dac6c14a9c4f752770c51b14 --amdgpu-family gfx110-all
  ```
