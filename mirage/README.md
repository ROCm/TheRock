...
`DS_CMPST_{B32,F32}`,
`DS_{ADD,MIN,MAX}_F32`, `DS_PK_ADD_{F16,BF16}`,
`DS_WRITE_ADDTID_B32`, `DS_READ_ADDTID_B32`,
`DS_{SWIZZLE,PERMUTE,BPERMUTE}_B32`,
...
`DS_{MIN,MAX}_{I64,U64,F64}`, `DS_{AND,OR,XOR,MSKOR}_B64`,
`DS_CMPST_{B64,F64}`, `DS_ADD_F64`,
`DS_PK_ADD_{F16,BF16}`, `DS_WRITE_ADDTID_B32`, `DS_READ_ADDTID_B32`,
`DS_{SWIZZLE,PERMUTE,BPERMUTE}_B32`,
