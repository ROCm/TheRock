...
internal-opcode entrypoints for a small subset of ops: `S_MOV_B32`, `S_ADD_U32`,
...
`S_ADDC_U32`, `S_SUB_U32`, `S_SUBB_U32`, `S_MUL_I32`, `S_MULK_I32`,
...
`S_CMP_{EQ,LG,GT,GE,LT,LE}_{I32,U32}`, `S_CMPK_*`,
...
`DS_WRITE_B32`,
`DS_READ_B32`, `DS_ADD_U32`, `FLAT_LOAD_DWORD`,
...
`V_READLANE_B32`, and `V_WRITELANE_B32`, plus `VOP1` forms for
`V_CVT_F32_{I32,U32,F16,F64}`, `V_CVT_F64_{I32,U32}`,
