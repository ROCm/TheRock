...
459 executable phase-0 ops without leaving architecture-local `gfx1201` files, and
...
- The next coherent extension points now move further into `ENC_VDS` and `ENC_VOP3`, rather than more narrow `VOP1`/`VOP2`/`VOPC`/`VGLOBAL` seed churn.
