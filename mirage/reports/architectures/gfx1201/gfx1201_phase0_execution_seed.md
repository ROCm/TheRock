...
50 executable phase-0 ops without leaving architecture-local `gfx1201` files.
...
- The next coherent extension point is `ENC_VOP3`/half-conversion work rather than
  more 1-dword `SOPC`/`SOPP`/`VOP1`/`VOP2` seed growth.
