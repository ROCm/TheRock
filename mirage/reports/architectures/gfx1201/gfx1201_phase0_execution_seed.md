...
432 executable phase-0 ops without leaving architecture-local `gfx1201` files, and
...
- `ENC_VDS`: `DS_NOP`, `DS_ADD_F32`, `DS_ADD_U32`, `DS_SUB_U32`, `DS_RSUB_U32`, `DS_INC_U32`, `DS_DEC_U32`, `DS_MIN_I32`, `DS_MIN_U32`, `DS_MAX_I32`, `DS_MAX_U32`, `DS_AND_B32`, `DS_OR_B32`, `DS_XOR_B32`
...
- `DS_NOP` now decodes as a 2-dword nullary `ENC_VDS` seed, and `DS_ADD_F32`, `DS_ADD_U32`, `DS_SUB_U32`, `DS_RSUB_U32`, `DS_INC_U32`, `DS_DEC_U32`, `DS_MIN_I32`, `DS_MIN_U32`, `DS_MAX_I32`, `DS_MAX_U32`, `DS_AND_B32`, `DS_OR_B32`, and `DS_XOR_B32` now decode on the same real one-address local LDS path, using `VADDR`, `DATA0`, and `offset0` while rejecting `GDS` and nonzero `offset1`.
- `DS_NOP` now executes as a local no-op, and `DS_ADD_F32`, `DS_ADD_U32`, `DS_SUB_U32`, `DS_RSUB_U32`, `DS_INC_U32`, `DS_DEC_U32`, `DS_MIN_I32`, `DS_MIN_U32`, `DS_MAX_I32`, `DS_MAX_U32`, `DS_AND_B32`, `DS_OR_B32`, and `DS_XOR_B32` now execute lane-wise under `exec_mask` through `ExecutionMemory` as the first architecture-local LDS update slice, using `VADDR + offset0` addressing while preserving inactive lanes and leaving the non-return forms without `VDST` writeback.
...
- `ENC_VDS` now has its first architecture-local executable footholds through `DS_NOP` and the one-address non-return 32-bit LDS update slice `DS_ADD_F32`, `DS_ADD_U32`, `DS_SUB_U32`, `DS_RSUB_U32`, `DS_INC_U32`, `DS_DEC_U32`, `DS_MIN_I32`, `DS_MIN_U32`, `DS_MAX_I32`, `DS_MAX_U32`, `DS_AND_B32`, `DS_OR_B32`, and `DS_XOR_B32`.
