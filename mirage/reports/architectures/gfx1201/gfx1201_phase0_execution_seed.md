...
445 executable phase-0 ops without leaving architecture-local `gfx1201` files, and
...
- `DS_NOP` now decodes as a 2-dword nullary `ENC_VDS` seed, and the one-address 32-bit LDS slice now decodes on the same real local path: the non-return ops `DS_ADD_F32`, `DS_ADD_U32`, `DS_SUB_U32`, `DS_RSUB_U32`, `DS_INC_U32`, `DS_DEC_U32`, `DS_MIN_I32`, `DS_MIN_U32`, `DS_MAX_I32`, `DS_MAX_U32`, `DS_AND_B32`, `DS_OR_B32`, and `DS_XOR_B32`, plus the matching return-value ops `DS_ADD_RTN_F32`, `DS_ADD_RTN_U32`, `DS_SUB_RTN_U32`, `DS_RSUB_RTN_U32`, `DS_INC_RTN_U32`, `DS_DEC_RTN_U32`, `DS_MIN_RTN_I32`, `DS_MIN_RTN_U32`, `DS_MAX_RTN_I32`, `DS_MAX_RTN_U32`, `DS_AND_RTN_B32`, `DS_OR_RTN_B32`, and `DS_XOR_RTN_B32`, using `VADDR`, `DATA0`, `VDST` on the return path, and `offset0` while rejecting `GDS` and nonzero `offset1`.
- `DS_NOP` now executes as a local no-op, and the one-address 32-bit LDS slice now executes lane-wise under `exec_mask` through `ExecutionMemory`: the non-return ops `DS_ADD_F32`, `DS_ADD_U32`, `DS_SUB_U32`, `DS_RSUB_U32`, `DS_INC_U32`, `DS_DEC_U32`, `DS_MIN_I32`, `DS_MIN_U32`, `DS_MAX_I32`, `DS_MAX_U32`, `DS_AND_B32`, `DS_OR_B32`, and `DS_XOR_B32`, plus the matching return-value ops `DS_ADD_RTN_F32`, `DS_ADD_RTN_U32`, `DS_SUB_RTN_U32`, `DS_RSUB_RTN_U32`, `DS_INC_RTN_U32`, `DS_DEC_RTN_U32`, `DS_MIN_RTN_I32`, `DS_MIN_RTN_U32`, `DS_MAX_RTN_I32`, `DS_MAX_RTN_U32`, `DS_AND_RTN_B32`, `DS_OR_RTN_B32`, and `DS_XOR_RTN_B32` that also write the pre-update LDS value into `VDST` for active lanes.
