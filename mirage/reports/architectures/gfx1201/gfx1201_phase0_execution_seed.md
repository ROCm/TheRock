...
382 executable phase-0 ops without leaving architecture-local `gfx1201` files, and
...
- `GLOBAL_LOAD_U8`, `GLOBAL_LOAD_I8`, `GLOBAL_LOAD_U16`, `GLOBAL_LOAD_I16`, `GLOBAL_LOAD_B32`, `GLOBAL_LOAD_B64`, `GLOBAL_LOAD_B96`, `GLOBAL_LOAD_B128`, `GLOBAL_LOAD_ADDTID_B32`, `GLOBAL_LOAD_TR_B64`, `GLOBAL_LOAD_TR_B128`, `GLOBAL_LOAD_D16_U8`, `GLOBAL_LOAD_D16_I8`, `GLOBAL_LOAD_D16_B16`, `GLOBAL_LOAD_D16_HI_U8`, `GLOBAL_LOAD_D16_HI_I8`, `GLOBAL_LOAD_D16_HI_B16`, `GLOBAL_STORE_B8`, `GLOBAL_STORE_B16`, `GLOBAL_STORE_B32`, `GLOBAL_STORE_B64`, `GLOBAL_STORE_B96`, `GLOBAL_STORE_B128`, `GLOBAL_STORE_ADDTID_B32`, `GLOBAL_STORE_D16_HI_B8`, and `GLOBAL_STORE_D16_HI_B16` now decode and execute as the real wave32-local per-lane global-memory read/write slice on both the decoded and compiled seed paths, combining `VADDR`, scalar `SADDR`, inline offsets, or lane-id-scaled ADDTID addressing through `ExecutionMemory` while keeping the new ADDTID, TR, and D16 forms architecture-local.
...
- `ENC_VGLOBAL` now has executable footholds through `GLOBAL_INV`, `GLOBAL_WB`, `GLOBAL_WBINV`, the plain `GLOBAL_LOAD_U8`/`I8`/`U16`/`I16`/`B32`/`B64`/`B96`/`B128` slice, `GLOBAL_LOAD_ADDTID_B32`, `GLOBAL_LOAD_TR_B64`/`B128`, the packed `GLOBAL_LOAD_D16_U8`/`I8`/`B16` and `GLOBAL_LOAD_D16_HI_U8`/`I8`/`B16` slice, the plain `GLOBAL_STORE_B8`/`B16`/`B32`/`B64`/`B96`/`B128` slice, `GLOBAL_STORE_ADDTID_B32`, and `GLOBAL_STORE_D16_HI_B8`/`B16`, but the broader `BLOCK` and atomic global-memory seed surface is still route-only in this slice.
