...
- The boundary report now also carries the next empty 50-slice window through opcode `1814..1863`, so the current continuation remains metadata-only.
