...
- Phase-0 executable opcodes: `412`
- Wave size: `32`
...
- `ENC_VGLOBAL`: example `GLOBAL_LOAD_B32`, seeded `65`, executable `59` via `GLOBAL_ATOMIC_ADD_U32`, as-is `3`, decoder-rollup `0`, semantic-only `0`, gfx1201-specific `62`
...
and the 64-bit integer atomic slice `GLOBAL_ATOMIC_SWAP_B64`, `GLOBAL_ATOMIC_CMPSWAP_B64`, `GLOBAL_ATOMIC_ADD/SUB_U64`, `GLOBAL_ATOMIC_MIN/MAX_I64/U64`,
`GLOBAL_ATOMIC_AND/OR/XOR_B64`, `GLOBAL_ATOMIC_INC_U64`, and `GLOBAL_ATOMIC_DEC_U64`,
leaving the `F32`, packed-half, and ordered-add atomic vector-memory surface as the remaining local `ENC_VGLOBAL` boundary.
