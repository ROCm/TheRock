...
- The boundary report now also carries the next empty 50-slice window through opcode `1764..1813`, so the current continuation remains metadata-only.
