...
- The boundary report now also carries the next empty 50-slice window through opcode `1814..1863`, and the next batch window through opcode `1864..1913`, so the current continuation remains metadata-only.
