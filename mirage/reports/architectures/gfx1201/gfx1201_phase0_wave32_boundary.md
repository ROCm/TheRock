...
- Phase-0 executable opcodes: `514`
- Wave size: `32`
...
- `ENC_VDS`: example `DS_ADD_U32`, seeded `123`, executable `96` via `DS_ADD_F32`, as-is `27`, decoder-rollup `38`, semantic-only `0`, gfx1201-specific `58`
