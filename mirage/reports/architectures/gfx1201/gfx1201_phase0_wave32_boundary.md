...
- Phase-0 executable opcodes: `432`
- Wave size: `32`
...
- `ENC_VDS`: example `DS_ADD_U32`, seeded `123`, executable `14` via `DS_ADD_F32`, as-is `27`, decoder-rollup `38`, semantic-only `0`, gfx1201-specific `58`
...
`ENC_VDS` now has its first architecture-local executable footholds through `DS_NOP` and the one-address non-return
32-bit LDS update slice `DS_ADD_F32`, `DS_ADD_U32`, `DS_SUB_U32`, `DS_RSUB_U32`, `DS_INC_U32`, `DS_DEC_U32`,
`DS_MIN_I32`, `DS_MIN_U32`, `DS_MAX_I32`, `DS_MAX_U32`, `DS_AND_B32`, `DS_OR_B32`, and `DS_XOR_B32`, while
