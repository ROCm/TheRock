...
- The boundary report now also carries the next empty 50-slice window through opcode `1814..1863`, the next batch window through opcode `1864..1913`, and the next batch window through opcode `1914..1963`, so the current continuation remains metadata-only.
