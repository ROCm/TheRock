...
- Phase-0 executable opcodes: `467`
- Wave size: `32`
...
- `ENC_VDS`: example `DS_ADD_U32`, seeded `123`, executable `49` via `DS_ADD_F32`, as-is `27`, decoder-rollup `38`, semantic-only `0`, gfx1201-specific `58`
