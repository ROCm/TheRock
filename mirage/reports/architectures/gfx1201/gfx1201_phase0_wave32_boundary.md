...
- The boundary report now also carries an extended empty-window metadata chain through opcode `814..863`, so the current continuation remains metadata-only.
