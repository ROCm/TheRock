...
- Phase-0 executable opcodes: `479`
- Wave size: `32`
...
- `ENC_VDS`: example `DS_ADD_U32`, seeded `123`, executable `61` via `DS_ADD_F32`, as-is `27`, decoder-rollup `38`, semantic-only `0`, gfx1201-specific `58`
...
`DS_COND_SUB_U32`, `DS_SUB_CLAMP_U32`, `DS_MIN_I32`, `DS_MIN_U32`, `DS_MAX_I32`, `DS_MAX_U32`, `DS_AND_B32`,
...
`DS_SUB_CLAMP_RTN_U32`, `DS_MIN_RTN_I32`, `DS_MIN_RTN_U32`, `DS_MAX_RTN_I32`, `DS_MAX_RTN_U32`, `DS_AND_RTN_B32`,
`DS_OR_RTN_B32`, and `DS_XOR_RTN_B32`, the simple one-address LDS load slice `DS_LOAD_B32`, `DS_LOAD_B64`,
...
`DS_STORE_B128`, `DS_STORE_B8_D16_HI`, `DS_STORE_B16_D16_HI`, `DS_PK_ADD_RTN_F16`, `DS_PK_ADD_F16`, `DS_PK_ADD_RTN_BF16`, `DS_PK_ADD_BF16`, `DS_MIN_NUM_RTN_F32`, `DS_MIN_NUM_F32`, `DS_MAX_NUM_RTN_F32`, and `DS_MAX_NUM_F32`, while
