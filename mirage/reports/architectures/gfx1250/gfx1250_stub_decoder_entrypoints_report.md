...
- Route manifests:
  ...
  - exact VOP3P first-50 batch validation now covers the leading `SeedFamily::kVop3p` slice through `V_WMMA_F32_16X16X4_F32_w32`: the routed packed BF16, SWMMAC, and early WMMA forms keep exact route-keyed parity, selector/manifest consistency, and local operand-layout / descriptor exactness
