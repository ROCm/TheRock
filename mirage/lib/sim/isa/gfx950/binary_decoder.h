#ifndef MIRAGE_SIM_ISA_GFX950_BINARY_DECODER_ARCH_H_
#define MIRAGE_SIM_ISA_GFX950_BINARY_DECODER_ARCH_H_
...
class Gfx950BinaryDecoder {
 ...
 private:
  ...
  bool DecodeSmem(std::span<const std::uint32_t> words,
                  ...
                  std::size_t* words_consumed,
                  std::string* error_message) const;
  bool DecodeMubuf(std::span<const std::uint32_t> words,
                   DecodedInstruction* instruction,
                   std::size_t* words_consumed,
                   std::string* error_message) const;
...
#endif  // MIRAGE_SIM_ISA_GFX950_BINARY_DECODER_ARCH_H_
