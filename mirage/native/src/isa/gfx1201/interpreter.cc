...
bool TryCompileExecutableOpcode(std::string_view opcode,
  ...
  if (opcode == "GLOBAL_LOAD_ADDTID_B32") {
  ...
  if (opcode == "GLOBAL_LOAD_D16_U8") {
    *compiled_opcode = Gfx1201CompiledOpcode::kGlobalLoadD16U8;
    return true;
  }
  if (opcode == "GLOBAL_LOAD_D16_I8") {
    *compiled_opcode = Gfx1201CompiledOpcode::kGlobalLoadD16I8;
    return true;
  }
  if (opcode == "GLOBAL_LOAD_D16_B16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kGlobalLoadD16B16;
    return true;
  }
  if (opcode == "GLOBAL_LOAD_D16_HI_U8") {
    *compiled_opcode = Gfx1201CompiledOpcode::kGlobalLoadD16HiU8;
    return true;
  }
  if (opcode == "GLOBAL_LOAD_D16_HI_I8") {
    *compiled_opcode = Gfx1201CompiledOpcode::kGlobalLoadD16HiI8;
    return true;
  }
  if (opcode == "GLOBAL_LOAD_D16_HI_B16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kGlobalLoadD16HiB16;
    return true;
  }
  ...
  if (opcode == "GLOBAL_STORE_D16_HI_B8") {
    *compiled_opcode = Gfx1201CompiledOpcode::kGlobalStoreD16HiB8;
    return true;
  }
  ...
  if (opcode == "DS_COND_SUB_RTN_U32") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsCondSubRtnU32;
    return true;
  }
  if (opcode == "DS_COND_SUB_U32") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsCondSubU32;
    return true;
  }
  if (opcode == "DS_SUB_CLAMP_RTN_U32") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsSubClampRtnU32;
    return true;
  }
  if (opcode == "DS_SUB_CLAMP_U32") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsSubClampU32;
    return true;
  }
  if (opcode == "DS_PK_ADD_RTN_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsPkAddRtnF16;
    return true;
  }
  if (opcode == "DS_PK_ADD_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsPkAddF16;
    return true;
  }
  if (opcode == "DS_PK_ADD_RTN_BF16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsPkAddRtnBf16;
    return true;
  }
  ...
  if (opcode == "DS_XOR_B64") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsXorB64;
    return true;
  }
  ...
  if (opcode == "DS_LOAD_B96") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsLoadB96;
    return true;
  }
  if (opcode == "DS_LOAD_B128") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsLoadB128;
    return true;
  }
  if (opcode == "DS_LOAD_I8") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsLoadI8;
    return true;
  }
  if (opcode == "DS_LOAD_U8") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsLoadU8;
    return true;
  }
  if (opcode == "DS_LOAD_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kDsLoadI16;
    return true;
  }
  ...
  if (opcode == "S_PREFETCH_INST_PC_REL" ||
      opcode == "S_PREFETCH_DATA_PC_REL") {
    *compiled_opcode = Gfx1201CompiledOpcode::kSNop;
    return true;
  }
  if (opcode == "S_PREFETCH_INST" || opcode == "S_PREFETCH_DATA" ||
      opcode == "S_BUFFER_PREFETCH_DATA") {
    *compiled_opcode = Gfx1201CompiledOpcode::kSNop;
    return true;
  }
  if (opcode == "S_ATC_PROBE" || opcode == "S_ATC_PROBE_BUFFER") {
    *compiled_opcode = Gfx1201CompiledOpcode::kSNop;
    return true;
  }
  if (opcode == "V_NOP") {
  ...
  if (opcode == "V_CMP_EQ_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpEqI16;
    return true;
  }
  if (opcode == "V_CMP_EQ_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpEqU16;
    return true;
  }
  if (opcode == "V_CMP_GE_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpGeI16;
    return true;
  }
  if (opcode == "V_CMP_GE_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpGeU16;
    return true;
  }
  if (opcode == "V_CMP_GT_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpGtI16;
    return true;
  }
  if (opcode == "V_CMP_GT_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpGtU16;
    return true;
  }
  if (opcode == "V_CMP_LE_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpLeI16;
    return true;
  }
  if (opcode == "V_CMP_LE_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpLeU16;
    return true;
  }
  if (opcode == "V_CMP_LT_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpLtI16;
    return true;
  }
  if (opcode == "V_CMP_LT_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpLtU16;
    return true;
  }
  if (opcode == "V_CMP_NE_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpNeI16;
    return true;
  }
  if (opcode == "V_CMP_NE_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpNeU16;
    return true;
  }
  if (opcode == "V_CMPX_EQ_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxEqI16;
    return true;
  }
  if (opcode == "V_CMPX_EQ_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxEqU16;
    return true;
  }
  if (opcode == "V_CMPX_GE_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxGeI16;
    return true;
  }
  if (opcode == "V_CMPX_GE_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxGeU16;
    return true;
  }
  if (opcode == "V_CMPX_GT_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxGtI16;
    return true;
  }
  if (opcode == "V_CMPX_GT_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxGtU16;
    return true;
  }
  if (opcode == "V_CMPX_LE_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxLeI16;
    return true;
  }
  if (opcode == "V_CMPX_LE_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxLeU16;
    return true;
  }
  if (opcode == "V_CMPX_LT_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxLtI16;
    return true;
  }
  if (opcode == "V_CMPX_LT_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxLtU16;
    return true;
  }
  if (opcode == "V_CMPX_NE_I16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxNeI16;
    return true;
  }
  if (opcode == "V_CMPX_NE_U16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxNeU16;
    return true;
  }
  ...
  if (opcode == "V_CMP_CLASS_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpClassF16;
    return true;
  }
  if (opcode == "V_CMP_EQ_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpEqF16;
    return true;
  }
  if (opcode == "V_CMP_GE_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpGeF16;
    return true;
  }
  if (opcode == "V_CMP_GT_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpGtF16;
    return true;
  }
  if (opcode == "V_CMP_LE_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpLeF16;
    return true;
  }
  if (opcode == "V_CMP_LG_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpLgF16;
    return true;
  }
  if (opcode == "V_CMP_LT_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpLtF16;
    return true;
  }
  if (opcode == "V_CMP_NEQ_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpNeqF16;
    return true;
  }
  if (opcode == "V_CMP_O_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpOF16;
    return true;
  }
  if (opcode == "V_CMP_U_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpUF16;
    return true;
  }
  if (opcode == "V_CMP_NGE_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpNgeF16;
    return true;
  }
  if (opcode == "V_CMP_NLG_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpNlgF16;
    return true;
  }
  if (opcode == "V_CMP_NGT_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpNgtF16;
    return true;
  }
  if (opcode == "V_CMP_NLE_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpNleF16;
    return true;
  }
  if (opcode == "V_CMP_NLT_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpNltF16;
    return true;
  }
  if (opcode == "V_CMPX_CLASS_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxClassF16;
    return true;
  }
  if (opcode == "V_CMPX_EQ_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxEqF16;
    return true;
  }
  if (opcode == "V_CMPX_GE_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxGeF16;
    return true;
  }
  if (opcode == "V_CMPX_GT_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxGtF16;
    return true;
  }
  if (opcode == "V_CMPX_LE_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxLeF16;
    return true;
  }
  if (opcode == "V_CMPX_LG_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxLgF16;
    return true;
  }
  if (opcode == "V_CMPX_LT_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxLtF16;
    return true;
  }
  if (opcode == "V_CMPX_NEQ_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxNeqF16;
    return true;
  }
  if (opcode == "V_CMPX_O_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxOF16;
    return true;
  }
  if (opcode == "V_CMPX_U_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxUF16;
    return true;
  }
  if (opcode == "V_CMPX_NGE_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxNgeF16;
    return true;
  }
  if (opcode == "V_CMPX_NLG_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxNlgF16;
    return true;
  }
  if (opcode == "V_CMPX_NGT_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxNgtF16;
    return true;
  }
  if (opcode == "V_CMPX_NLE_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxNleF16;
    return true;
  }
  if (opcode == "V_CMPX_NLT_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCmpxNltF16;
    return true;
  }
  ...
  if (opcode == "V_CVT_I16_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCvtI16F16;
    return true;
  }
  ...
  if (opcode == "V_EXP_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVExpF16;
    return true;
  }
  if (opcode == "V_EXP_F32") {
  ...
  if (opcode == "V_LOG_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVLogF16;
    return true;
  }
  if (opcode == "V_LOG_F32") {
  ...
  if (opcode == "V_RCP_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVRcpF16;
    return true;
  }
  if (opcode == "V_RCP_F32") {
  ...
  if (opcode == "V_RSQ_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVRsqF16;
    return true;
  }
  if (opcode == "V_RSQ_F32") {
  ...
  if (opcode == "V_SQRT_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVSqrtF16;
    return true;
  }
  if (opcode == "V_SQRT_F32") {
  ...
  if (opcode == "V_SIN_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVSinF16;
    return true;
  }
  if (opcode == "V_SIN_F32") {
  ...
  if (opcode == "V_COS_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCosF16;
    return true;
  }
  if (opcode == "V_COS_F32") {
  ...
  if (opcode == "V_FREXP_EXP_I16_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVFrexpExpI16F16;
    return true;
  }
  ...
  if (opcode == "V_FREXP_MANT_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVFrexpMantF16;
    return true;
  }
  ...
  if (opcode == "V_FRACT_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVFractF16;
    return true;
  }
  ...
  if (opcode == "V_TRUNC_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVTruncF16;
    return true;
  }
  if (opcode == "V_CEIL_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVCeilF16;
    return true;
  }
  if (opcode == "V_RNDNE_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVRndneF16;
    return true;
  }
  if (opcode == "V_FLOOR_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVFloorF16;
    return true;
  }
  ...
  if (opcode == "V_ADD_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVAddF16;
    return true;
  }
  if (opcode == "V_SUB_F16") {
    *compiled_opcode = Gfx1201CompiledOpcode::kVSubF16;
    return true;
  }
...
bool ComputeVglobalAddTidAddress(const DecodedInstruction& instruction,
                                 const WaveExecutionState& state,
                                 std::size_t lane_index,
                                 std::uint64_t* address,
                                 std::string* error_message) {
  if (address == nullptr) {
    if (error_message != nullptr) {
      *error_message = "VGLOBAL ADDTID address output must not be null";
    }
    return false;
  }
...
bool IsDsAtomic64Opcode(std::string_view opcode) {
  return opcode == "DS_ADD_U64" || opcode == "DS_SUB_U64" ||
...
std::size_t ComputeDsSwizzleSourceLane(std::size_t lane_index,
  ...
  const std::size_t row_base = lane_index & ~std::size_t{31};
  const std::uint32_t lane_in_row = static_cast<std::uint32_t>(lane_index & 31u);
  ...
  return row_base + static_cast<std::size_t>(((lane_in_row & and_mask) |
                                              or_mask) ^
                                             xor_mask);
}
...
void ComputeDsSwizzleResults(
    ...
    std::uint16_t pattern,
    const std::array<std::uint32_t, kGfx1201LaneCount>& source_values,
...
bool ExecuteDsAtomic32AtAddress(const DecodedInstruction& instruction,
                                std::uint64_t address,
                                std::size_t lane_index,
                                WaveExecutionState* state,
                                ExecutionMemory* memory,
  ...
  if (!memory->LoadU32(address, &old_value)) {
    if (error_message != nullptr) {
      *error_message = std::string(instruction.opcode) + " memory read failed";
    }
    return false;
  }
  ...
  if (instruction.opcode == "DS_ADD_F32" ||
    ...
    new_value = AtomicDecU32(old_value, data_value);
  } else if (instruction.opcode == "DS_COND_SUB_U32" ||
             instruction.opcode == "DS_COND_SUB_RTN_U32") {
    new_value = old_value >= data_value ? old_value - data_value : old_value;
  } else if (instruction.opcode == "DS_SUB_CLAMP_U32" ||
             instruction.opcode == "DS_SUB_CLAMP_RTN_U32") {
    new_value = data_value > old_value ? data_value - old_value : 0u;
  } else if (instruction.opcode == "DS_PK_ADD_F16" ||
             instruction.opcode == "DS_PK_ADD_RTN_F16") {
    new_value = PackedHalfAdd(old_value, data_value);
...
bool ExecuteDsLoadAtAddress(const DecodedInstruction& instruction,
  ...
  if (opcode == "DS_LOAD_B64") {
    ...
    const std::uint64_t value = static_cast<std::uint64_t>(low) |
                                (static_cast<std::uint64_t>(high) << 32);
    return WriteWideVectorOperand(instruction.operands[0], lane_index, value,
                                  state, error_message);
  }

  if (opcode == "DS_LOAD_B96" || opcode == "DS_LOAD_B128") {
    const std::size_t word_count = opcode == "DS_LOAD_B96" ? 3u : 4u;
  ...
  if (opcode == "DS_LOAD_I8" || opcode == "DS_LOAD_U8") {
    std::uint8_t value = 0;
...
bool ExecuteVectorGlobalLoadAtAddress(const DecodedInstruction& instruction,
  ...
  if (opcode == "GLOBAL_LOAD_B32" || opcode == "GLOBAL_LOAD_ADDTID_B32") {
    std::uint32_t value = 0;
    if (!memory->LoadU32(address, &value)) {
      if (error_message != nullptr) {
        *error_message = std::string(opcode) + " memory read failed";
  ...
  if (opcode == "GLOBAL_LOAD_D16_U8" || opcode == "GLOBAL_LOAD_D16_I8" ||
      opcode == "GLOBAL_LOAD_D16_HI_U8" ||
      opcode == "GLOBAL_LOAD_D16_HI_I8") {
    std::uint8_t value = 0;
    if (!memory->LoadU8(address, &value)) {
      if (error_message != nullptr) {
        *error_message = std::string(opcode) + " memory read failed";
    ...
    const bool sign_extend = opcode == "GLOBAL_LOAD_D16_I8" ||
                             opcode == "GLOBAL_LOAD_D16_HI_I8";
    const bool high_half = opcode == "GLOBAL_LOAD_D16_HI_U8" ||
                           opcode == "GLOBAL_LOAD_D16_HI_I8";
    const std::uint16_t payload = sign_extend
                                      ? static_cast<std::uint16_t>(
                                            static_cast<std::int16_t>(
  ...
  if (opcode == "GLOBAL_LOAD_D16_B16" || opcode == "GLOBAL_LOAD_D16_HI_B16") {
    std::uint16_t value = 0;
    if (!memory->LoadU16(address, &value)) {
      if (error_message != nullptr) {
        *error_message = std::string(opcode) + " memory read failed";
    ...
    return write_d16_half(value, opcode == "GLOBAL_LOAD_D16_HI_B16");
  }
...
bool ExecuteVectorGlobalStoreAtAddress(const DecodedInstruction& instruction,
  ...
  if (opcode == "GLOBAL_STORE_D16_HI_B8") {
    ...
    if (!memory->StoreU8(address, static_cast<std::uint8_t>((value >> 16) & 0xffu))) {
      if (error_message != nullptr) {
        *error_message = "GLOBAL_STORE_D16_HI_B8 memory write failed";
      }
      return false;
    }
    if (error_message != nullptr) {
  ...
  if (opcode == "GLOBAL_STORE_D16_HI_B16") {
    ...
    if (!memory->StoreU16(address, static_cast<std::uint16_t>(value >> 16))) {
      if (error_message != nullptr) {
        *error_message = "GLOBAL_STORE_D16_HI_B16 memory write failed";
      }
      return false;
    }
    if (error_message != nullptr) {
  ...
  if (opcode == "GLOBAL_STORE_B32" || opcode == "GLOBAL_STORE_ADDTID_B32") {
    const std::uint32_t value = ReadVectorOperand(instruction.operands[0], state,
                                                  lane_index, error_message);
    if (error_message != nullptr && !error_message->empty()) {
      return false;
...
std::uint32_t EvaluateVectorUnarySeedInstruction(std::string_view opcode,
  ...
  if (opcode == "V_CVT_I16_F16") {
    return static_cast<std::uint32_t>(static_cast<std::uint16_t>(
        TruncateFloatToI32(ExpandFp16ToFloat(static_cast<std::uint16_t>(value)))));
  }
  if (opcode == "V_CVT_U16_F16") {
    return static_cast<std::uint32_t>(static_cast<std::uint16_t>(
  ...
  if (opcode == "V_EXP_F16" || opcode == "V_LOG_F16" ||
      opcode == "V_RCP_F16" || opcode == "V_RSQ_F16" ||
      opcode == "V_SQRT_F16" || opcode == "V_SIN_F16" ||
      opcode == "V_COS_F16") {
    return static_cast<std::uint32_t>(CompressFloatToFp16Bits(
        EvaluateUnaryFloatMathF16(
            opcode, ExpandFp16ToFloat(static_cast<std::uint16_t>(value)))));
  }
  if (opcode == "V_FREXP_EXP_I16_F16") {
    return static_cast<std::uint32_t>(static_cast<std::uint16_t>(
        EvaluateFrexpExpI32(ExpandFp16ToFloat(static_cast<std::uint16_t>(value)))));
  }
  if (opcode == "V_FREXP_MANT_F16") {
    return static_cast<std::uint32_t>(CompressFloatToFp16Bits(
        EvaluateFrexpMantissaF32(
            ExpandFp16ToFloat(static_cast<std::uint16_t>(value)))));
  }
  if (opcode == "V_FRACT_F16") {
    const float input = ExpandFp16ToFloat(static_cast<std::uint16_t>(value));
    return static_cast<std::uint32_t>(
        CompressFloatToFp16Bits(input - std::floor(input)));
  }
  if (opcode == "V_TRUNC_F16") {
    return static_cast<std::uint32_t>(CompressFloatToFp16Bits(
        std::trunc(ExpandFp16ToFloat(static_cast<std::uint16_t>(value)))));
  }
  if (opcode == "V_CEIL_F16") {
    return static_cast<std::uint32_t>(CompressFloatToFp16Bits(
        std::ceil(ExpandFp16ToFloat(static_cast<std::uint16_t>(value)))));
  }
  if (opcode == "V_RNDNE_F16") {
    return static_cast<std::uint32_t>(CompressFloatToFp16Bits(
        std::nearbyint(ExpandFp16ToFloat(static_cast<std::uint16_t>(value)))));
  }
  if (opcode == "V_FLOOR_F16") {
    return static_cast<std::uint32_t>(CompressFloatToFp16Bits(
        std::floor(ExpandFp16ToFloat(static_cast<std::uint16_t>(value)))));
  }
...
std::uint32_t EvaluateVectorBinaryHalfSeedInstruction(std::string_view opcode,
                                                      std::uint32_t lhs,
                                                      std::uint32_t rhs) {
  ...
  if (opcode == "V_MAX_NUM_F16") {
    return CompressFloatToFp16Bits(std::fmax(lhs_value, rhs_value));
  }
  return 0u;
}
...
float ExpandFp16ToFloat(std::uint16_t bits) {
  ...
  if (exponent == 0u) {
    ...
    value = std::ldexp(static_cast<float>(0x0400u + mantissa),
...
bool IsVectorCompareSeedInstruction(std::string_view opcode) {
  ...
  return normalized_opcode == "V_CMP_EQ_I32" ||
         ...
         normalized_opcode == "V_CMP_EQ_I16" ||
         normalized_opcode == "V_CMP_NE_I16" ||
         normalized_opcode == "V_CMP_LT_I16" ||
         normalized_opcode == "V_CMP_LE_I16" ||
         normalized_opcode == "V_CMP_GT_I16" ||
         normalized_opcode == "V_CMP_GE_I16" ||
         normalized_opcode == "V_CMP_EQ_U16" ||
         normalized_opcode == "V_CMP_NE_U16" ||
         normalized_opcode == "V_CMP_LT_U16" ||
         normalized_opcode == "V_CMP_LE_U16" ||
         normalized_opcode == "V_CMP_GT_U16" ||
         normalized_opcode == "V_CMP_GE_U16" ||
         ...
         normalized_opcode == "V_CMP_CLASS_F16" ||
         normalized_opcode == "V_CMP_EQ_F16" ||
         normalized_opcode == "V_CMP_GE_F16" ||
         normalized_opcode == "V_CMP_GT_F16" ||
         normalized_opcode == "V_CMP_LE_F16" ||
         normalized_opcode == "V_CMP_LG_F16" ||
         normalized_opcode == "V_CMP_LT_F16" ||
         normalized_opcode == "V_CMP_NEQ_F16" ||
         normalized_opcode == "V_CMP_O_F16" ||
         normalized_opcode == "V_CMP_U_F16" ||
         normalized_opcode == "V_CMP_NGE_F16" ||
         normalized_opcode == "V_CMP_NLG_F16" ||
         normalized_opcode == "V_CMP_NGT_F16" ||
         normalized_opcode == "V_CMP_NLE_F16" ||
         normalized_opcode == "V_CMP_NLT_F16" ||
...
bool EvaluateVectorCompareSeedInstruction(std::string_view opcode,
  ...
  const std::string_view normalized_opcode =
      NormalizeVectorCompareSeedOpcode(opcode);
  if (normalized_opcode == "V_CMP_CLASS_F16") {
    return (ClassifyFp16Mask(static_cast<std::uint16_t>(lhs)) & rhs) != 0u;
  }
  if (normalized_opcode == "V_CMP_EQ_F16" ||
      normalized_opcode == "V_CMP_GE_F16" ||
      normalized_opcode == "V_CMP_GT_F16" ||
      normalized_opcode == "V_CMP_LE_F16" ||
      normalized_opcode == "V_CMP_LG_F16" ||
      ...
      normalized_opcode == "V_CMP_NLE_F16" ||
      normalized_opcode == "V_CMP_NLT_F16") {
    const float lhs_float = ExpandFp16ToFloat(static_cast<std::uint16_t>(lhs));
    const float rhs_float = ExpandFp16ToFloat(static_cast<std::uint16_t>(rhs));
    const bool unordered = std::isnan(lhs_float) || std::isnan(rhs_float);
    if (normalized_opcode == "V_CMP_EQ_F16") {
      return !unordered && lhs_float == rhs_float;
    }
    if (normalized_opcode == "V_CMP_GE_F16") {
      return !unordered && lhs_float >= rhs_float;
    }
    if (normalized_opcode == "V_CMP_GT_F16") {
      return !unordered && lhs_float > rhs_float;
    }
    if (normalized_opcode == "V_CMP_LE_F16") {
      return !unordered && lhs_float <= rhs_float;
    }
    if (normalized_opcode == "V_CMP_LG_F16") {
      return !unordered && lhs_float != rhs_float;
    }
    if (normalized_opcode == "V_CMP_LT_F16") {
      return !unordered && lhs_float < rhs_float;
    }
    if (normalized_opcode == "V_CMP_NEQ_F16") {
      return unordered || lhs_float != rhs_float;
    }
    if (normalized_opcode == "V_CMP_O_F16") {
      return !unordered;
    }
    if (normalized_opcode == "V_CMP_U_F16") {
      return unordered;
    }
    if (normalized_opcode == "V_CMP_NGE_F16") {
      return unordered || lhs_float < rhs_float;
    }
    if (normalized_opcode == "V_CMP_NLG_F16") {
      return unordered || lhs_float == rhs_float;
    }
    if (normalized_opcode == "V_CMP_NGT_F16") {
      return unordered || lhs_float <= rhs_float;
    }
    if (normalized_opcode == "V_CMP_NLE_F16") {
      return unordered || lhs_float > rhs_float;
    }
    return unordered || lhs_float >= rhs_float;
  }
  ...
  if (normalized_opcode == "V_CMP_EQ_I16") {
    return BitCast<std::int16_t>(static_cast<std::uint16_t>(lhs)) ==
           BitCast<std::int16_t>(static_cast<std::uint16_t>(rhs));
  }
  if (normalized_opcode == "V_CMP_NE_I16") {
    return BitCast<std::int16_t>(static_cast<std::uint16_t>(lhs)) !=
           BitCast<std::int16_t>(static_cast<std::uint16_t>(rhs));
  }
  if (normalized_opcode == "V_CMP_LT_I16") {
    return BitCast<std::int16_t>(static_cast<std::uint16_t>(lhs)) <
           BitCast<std::int16_t>(static_cast<std::uint16_t>(rhs));
  }
  if (normalized_opcode == "V_CMP_LE_I16") {
    return BitCast<std::int16_t>(static_cast<std::uint16_t>(lhs)) <=
           BitCast<std::int16_t>(static_cast<std::uint16_t>(rhs));
  }
  if (normalized_opcode == "V_CMP_GT_I16") {
    return BitCast<std::int16_t>(static_cast<std::uint16_t>(lhs)) >
           BitCast<std::int16_t>(static_cast<std::uint16_t>(rhs));
  }
  if (normalized_opcode == "V_CMP_GE_I16") {
    return BitCast<std::int16_t>(static_cast<std::uint16_t>(lhs)) >=
           BitCast<std::int16_t>(static_cast<std::uint16_t>(rhs));
  }
  if (normalized_opcode == "V_CMP_EQ_U16") {
    return static_cast<std::uint16_t>(lhs) == static_cast<std::uint16_t>(rhs);
  }
  if (normalized_opcode == "V_CMP_NE_U16") {
    return static_cast<std::uint16_t>(lhs) != static_cast<std::uint16_t>(rhs);
  }
  if (normalized_opcode == "V_CMP_LT_U16") {
    return static_cast<std::uint16_t>(lhs) < static_cast<std::uint16_t>(rhs);
  }
  if (normalized_opcode == "V_CMP_LE_U16") {
    return static_cast<std::uint16_t>(lhs) <= static_cast<std::uint16_t>(rhs);
  }
  if (normalized_opcode == "V_CMP_GT_U16") {
    return static_cast<std::uint16_t>(lhs) > static_cast<std::uint16_t>(rhs);
  }
  if (normalized_opcode == "V_CMP_GE_U16") {
    return static_cast<std::uint16_t>(lhs) >= static_cast<std::uint16_t>(rhs);
  }
...
bool ExecuteDecodedSeedInstruction(const DecodedInstruction& instruction,
  ...
  if (IsDsLoadOpcode(instruction.opcode)) {
    ...
    for (std::size_t lane_index = 0; lane_index < kGfx1201LaneCount;
      ...
      std::uint64_t address = 0;
      if (!ComputeDsLoadAddress(instruction, *state, lane_index, &address,
                                error_message)) {
        return false;
      }
      if (!ExecuteDsLoadAtAddress(instruction, address, lane_index, state,
                                  memory, error_message)) {
        return false;
      }
    }
  ...
  if (instruction.opcode == "GLOBAL_LOAD_U8" ||
      ...
      instruction.opcode == "GLOBAL_LOAD_D16_HI_U8" ||
      instruction.opcode == "GLOBAL_LOAD_D16_HI_I8" ||
      instruction.opcode == "GLOBAL_LOAD_D16_HI_B16") {
  ...
  if (instruction.opcode == "GLOBAL_LOAD_ADDTID_B32") {
    ...
    for (std::size_t lane_index = 0; lane_index < kGfx1201LaneCount;
      ...
      std::uint64_t address = 0;
      if (!ComputeVglobalAddTidAddress(instruction, *state, lane_index,
  ...
  if (instruction.opcode == "GLOBAL_STORE_B8" ||
      ...
      instruction.opcode == "GLOBAL_STORE_D16_HI_B8" ||
      instruction.opcode == "GLOBAL_STORE_D16_HI_B16") {
    if (!ValidateOperandCount(instruction, 4, error_message)) {
      return false;
    }
    if (memory == nullptr) {
  ...
  if (instruction.opcode == "GLOBAL_STORE_ADDTID_B32") {
    if (!ValidateOperandCount(instruction, 3, error_message)) {
      return false;
    }
    if (memory == nullptr) {
  ...
  if (instruction.opcode == "S_PREFETCH_INST" ||
      instruction.opcode == "S_PREFETCH_DATA" ||
      instruction.opcode == "S_BUFFER_PREFETCH_DATA") {
    return ValidateOperandCount(instruction, 4, error_message);
  }
...
bool ExecuteCompiledSeedInstruction(const Gfx1201CompiledInstruction& instruction,
  ...
  switch (instruction.opcode) {
    ...
    case Gfx1201CompiledOpcode::kGlobalLoadD16HiU8:
    case Gfx1201CompiledOpcode::kGlobalLoadD16HiI8:
    case Gfx1201CompiledOpcode::kGlobalLoadD16HiB16:
    ...
    case Gfx1201CompiledOpcode::kDsSubClampU32:
    case Gfx1201CompiledOpcode::kDsPkAddRtnF16:
    ...
    case Gfx1201CompiledOpcode::kDsLoadI8:
    ...
    case Gfx1201CompiledOpcode::kVCmpEqI16:
    case Gfx1201CompiledOpcode::kVCmpEqU16:
    case Gfx1201CompiledOpcode::kVCmpGeI16:
    case Gfx1201CompiledOpcode::kVCmpGeU16:
    case Gfx1201CompiledOpcode::kVCmpGtI16:
    case Gfx1201CompiledOpcode::kVCmpGtU16:
    case Gfx1201CompiledOpcode::kVCmpLeI16:
    case Gfx1201CompiledOpcode::kVCmpLeU16:
    case Gfx1201CompiledOpcode::kVCmpLtI16:
    case Gfx1201CompiledOpcode::kVCmpLtU16:
    case Gfx1201CompiledOpcode::kVCmpNeI16:
    case Gfx1201CompiledOpcode::kVCmpNeU16:
    case Gfx1201CompiledOpcode::kVCmpxEqI16:
    case Gfx1201CompiledOpcode::kVCmpxEqU16:
    case Gfx1201CompiledOpcode::kVCmpxGeI16:
    case Gfx1201CompiledOpcode::kVCmpxGeU16:
    case Gfx1201CompiledOpcode::kVCmpxGtI16:
    case Gfx1201CompiledOpcode::kVCmpxGtU16:
    case Gfx1201CompiledOpcode::kVCmpxLeI16:
    case Gfx1201CompiledOpcode::kVCmpxLeU16:
    case Gfx1201CompiledOpcode::kVCmpxLtI16:
    case Gfx1201CompiledOpcode::kVCmpxLtU16:
    case Gfx1201CompiledOpcode::kVCmpxNeI16:
    case Gfx1201CompiledOpcode::kVCmpxNeU16:
    ...
    case Gfx1201CompiledOpcode::kVCmpClassF16:
    case Gfx1201CompiledOpcode::kVCmpEqF16:
    case Gfx1201CompiledOpcode::kVCmpGeF16:
    case Gfx1201CompiledOpcode::kVCmpGtF16:
    case Gfx1201CompiledOpcode::kVCmpLeF16:
    case Gfx1201CompiledOpcode::kVCmpLgF16:
    case Gfx1201CompiledOpcode::kVCmpLtF16:
    case Gfx1201CompiledOpcode::kVCmpNeqF16:
    case Gfx1201CompiledOpcode::kVCmpOF16:
    case Gfx1201CompiledOpcode::kVCmpUF16:
    case Gfx1201CompiledOpcode::kVCmpNgeF16:
    case Gfx1201CompiledOpcode::kVCmpNlgF16:
    case Gfx1201CompiledOpcode::kVCmpNgtF16:
    case Gfx1201CompiledOpcode::kVCmpNleF16:
    case Gfx1201CompiledOpcode::kVCmpNltF16:
    case Gfx1201CompiledOpcode::kVCmpxClassF16:
    case Gfx1201CompiledOpcode::kVCmpxEqF16:
    case Gfx1201CompiledOpcode::kVCmpxGeF16:
    case Gfx1201CompiledOpcode::kVCmpxGtF16:
    case Gfx1201CompiledOpcode::kVCmpxLeF16:
    case Gfx1201CompiledOpcode::kVCmpxLgF16:
    case Gfx1201CompiledOpcode::kVCmpxLtF16:
    case Gfx1201CompiledOpcode::kVCmpxNeqF16:
    case Gfx1201CompiledOpcode::kVCmpxOF16:
    case Gfx1201CompiledOpcode::kVCmpxUF16:
    case Gfx1201CompiledOpcode::kVCmpxNgeF16:
    case Gfx1201CompiledOpcode::kVCmpxNlgF16:
    case Gfx1201CompiledOpcode::kVCmpxNgtF16:
    case Gfx1201CompiledOpcode::kVCmpxNleF16:
    case Gfx1201CompiledOpcode::kVCmpxNltF16:
    ...
    case Gfx1201CompiledOpcode::kVFrexpExpI16F16:
    case Gfx1201CompiledOpcode::kVFrexpExpI32F32:
    case Gfx1201CompiledOpcode::kVFrexpMantF16:
    case Gfx1201CompiledOpcode::kVFrexpMantF32:
    case Gfx1201CompiledOpcode::kVFractF16:
    ...
    case Gfx1201CompiledOpcode::kVTruncF16:
    case Gfx1201CompiledOpcode::kVCeilF16:
    case Gfx1201CompiledOpcode::kVRndneF16:
    case Gfx1201CompiledOpcode::kVFloorF16:
