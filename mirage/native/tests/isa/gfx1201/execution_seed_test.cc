...
constexpr std::array<DsRtnCase, 19> kDsRtnCases{{
    {"DS_ADD_RTN_F32", 121u,
     ...
     0x000u},
    {"DS_ADD_RTN_U32", 32u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsAddRtnU32, 33u, 97u, 113u,
     0x010u},
    {"DS_SUB_RTN_U32", 33u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsSubRtnU32, 34u, 98u, 114u,
     0x020u},
    {"DS_RSUB_RTN_U32", 34u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsRsubRtnU32, 35u, 99u, 115u,
     0x030u},
    {"DS_INC_RTN_U32", 35u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsIncRtnU32, 36u, 100u, 116u,
     0x040u},
    {"DS_DEC_RTN_U32", 36u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsDecRtnU32, 37u, 101u, 117u,
     0x050u},
    {"DS_MIN_RTN_I32", 37u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsMinRtnI32, 38u, 102u, 118u,
     0x060u},
    {"DS_MIN_RTN_U32", 39u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsMinRtnU32, 39u, 103u, 119u,
     0x070u},
    {"DS_MAX_RTN_I32", 38u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsMaxRtnI32, 40u, 104u, 120u,
     0x080u},
    {"DS_MAX_RTN_U32", 40u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsMaxRtnU32, 41u, 105u, 121u,
     0x090u},
    {"DS_AND_RTN_B32", 41u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsAndRtnB32, 42u, 106u, 122u,
     0x0a0u},
    {"DS_OR_RTN_B32", 42u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsOrRtnB32, 43u, 107u, 123u,
     0x0b0u},
    {"DS_XOR_RTN_B32", 43u,
...
constexpr std::array<DsWideCase, 28> kDsWideCases{{
    ...
    {"DS_MAX_NUM_RTN_F64", 115u,
     ...
     0x030u, true},
    {"DS_ADD_U64", 64u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsAddU64, 0u,
     32u, 0u, 0x040u, false},
    {"DS_SUB_U64", 65u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsSubU64, 0u,
     33u, 2u, 0x050u, false},
    {"DS_RSUB_U64", 66u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsRsubU64, 0u, 34u, 4u,
     0x060u, false},
    {"DS_INC_U64", 67u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsIncU64, 0u,
     35u, 6u, 0x070u, false},
    {"DS_DEC_U64", 68u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsDecU64, 0u,
     36u, 8u, 0x080u, false},
    {"DS_MIN_I64", 69u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsMinI64, 0u,
     37u, 10u, 0x090u, false},
    {"DS_MIN_U64", 71u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsMinU64, 0u,
     38u, 12u, 0x0a0u, false},
    {"DS_MAX_I64", 70u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsMaxI64, 0u,
     39u, 14u, 0x0b0u, false},
    {"DS_MAX_U64", 72u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsMaxU64, 0u,
     40u, 16u, 0x0c0u, false},
    {"DS_AND_B64", 73u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsAndB64, 0u,
     41u, 18u, 0x0d0u, false},
    {"DS_OR_B64", 74u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsOrB64, 0u,
...
constexpr std::array<DsLoadCase, 8> kDsLoadCases{{
    {"DS_LOAD_B32", 54u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadB32,
     48u, 109u, 0x000u},
    {"DS_LOAD_B64", 118u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadB64,
     49u, 110u, 0x010u},
    {"DS_LOAD_B96", 254u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadB96,
     51u, 111u, 0x020u},
    {"DS_LOAD_B128", 255u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadB128, 54u, 112u, 0x030u},
    {"DS_LOAD_I8", 57u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadI8,
     58u, 113u, 0x040u},
    {"DS_LOAD_U8", 58u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadU8,
     59u, 114u, 0x050u},
    {"DS_LOAD_I16", 59u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadI16,
     60u, 115u, 0x060u},
    {"DS_LOAD_U16", 60u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadU16,
     61u, 116u, 0x070u},
}};
...
constexpr std::uint64_t kDsStoreBaseAddress = 0x26000u;

constexpr std::array<DsStoreCase, 6> kDsStoreCases{{
    {"DS_STORE_B8", 30u, mirage::sim::isa::Gfx1201CompiledOpcode::kDsStoreB8,
     62u, 117u, 0x000u},
    {"DS_STORE_B16", 31u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsStoreB16, 63u, 118u,
     0x010u},
    {"DS_STORE_B32", 13u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsStoreB32, 64u, 119u,
     0x020u},
    {"DS_STORE_B64", 77u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsStoreB64, 65u, 120u,
     0x030u},
    {"DS_STORE_B96", 222u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsStoreB96, 67u, 121u,
     0x040u},
    {"DS_STORE_B128", 223u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsStoreB128, 70u, 122u,
     0x050u},
}};

struct DsLoadD16Case {
  const char* opcode;
  std::uint32_t op;
  mirage::sim::isa::Gfx1201CompiledOpcode compiled;
  std::uint16_t dest;
...
constexpr std::uint64_t kDsLoadD16BaseAddress = 0x36000u;

constexpr std::array<DsLoadD16Case, 6> kDsLoadD16Cases{{
    {"DS_LOAD_U8_D16", 162u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadU8D16, 74u, 123u,
     0x000u, false, false, true},
    {"DS_LOAD_U8_D16_HI", 163u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadU8D16Hi, 75u, 124u,
     0x010u, true, false, true},
    {"DS_LOAD_I8_D16", 164u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadI8D16, 76u, 125u,
     0x020u, false, true, true},
    {"DS_LOAD_I8_D16_HI", 165u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadI8D16Hi, 77u, 126u,
     0x030u, true, true, true},
    {"DS_LOAD_U16_D16", 166u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadU16D16, 78u, 127u,
     0x040u, false, false, false},
    {"DS_LOAD_U16_D16_HI", 167u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsLoadU16D16Hi, 79u, 20u,
     0x050u, true, false, false},
}};

struct DsStoreD16Case {
  const char* opcode;
  std::uint32_t op;
  mirage::sim::isa::Gfx1201CompiledOpcode compiled;
  std::uint16_t data;
...
constexpr std::uint64_t kDsStoreD16BaseAddress = 0x46000u;

constexpr std::array<DsStoreD16Case, 2> kDsStoreD16Cases{{
    {"DS_STORE_B8_D16_HI", 160u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsStoreB8D16Hi, 80u, 21u,
     0x000u, true},
    {"DS_STORE_B16_D16_HI", 161u,
     mirage::sim::isa::Gfx1201CompiledOpcode::kDsStoreB16D16Hi, 81u, 22u,
     0x010u, false},
}};
...
std::uint64_t DsLoadLaneBaseAddress(std::size_t case_index, std::size_t lane) {
  return DsLoadCaseBaseAddress(case_index) +
         static_cast<std::uint64_t>(lane) * 0x20u;
}
...
std::uint64_t DsStoreCaseBaseAddress(std::size_t case_index) {
  return kDsStoreBaseAddress + static_cast<std::uint64_t>(case_index) * 0x1000u;
}

std::uint64_t DsStoreLaneBaseAddress(std::size_t case_index, std::size_t lane) {
  return DsStoreCaseBaseAddress(case_index) +
         static_cast<std::uint64_t>(lane) * 0x20u;
}

std::uint64_t DsLoadD16CaseBaseAddress(std::size_t case_index) {
  return kDsLoadD16BaseAddress +
         static_cast<std::uint64_t>(case_index) * 0x1000u;
}

std::uint64_t DsLoadD16LaneBaseAddress(std::size_t case_index, std::size_t lane) {
  return DsLoadD16CaseBaseAddress(case_index) +
         static_cast<std::uint64_t>(lane) * 0x20u;
}

std::uint64_t DsStoreD16CaseBaseAddress(std::size_t case_index) {
  return kDsStoreD16BaseAddress +
         static_cast<std::uint64_t>(case_index) * 0x1000u;
}

std::uint64_t DsStoreD16LaneBaseAddress(std::size_t case_index,
                                        std::size_t lane) {
  return DsStoreD16CaseBaseAddress(case_index) +
         static_cast<std::uint64_t>(lane) * 0x20u;
}

std::size_t DsStoreWordCount(std::size_t case_index) {
  switch (case_index) {
    case 3:
      return 2u;
    case 4:
...
std::uint32_t InitialDsStoreMemoryWord(std::size_t case_index,
                                       std::size_t word_index,
                                       std::size_t lane) {
  return 0xe7000000u + static_cast<std::uint32_t>(case_index << 12) +
         static_cast<std::uint32_t>(word_index << 8) +
         static_cast<std::uint32_t>(lane);
}

std::uint32_t InitialDsStoreSourceWord(std::size_t case_index,
                                       std::size_t word_index,
                                       std::size_t lane) {
  switch (case_index) {
    case 0:
      return lane == 0u ? 0xabcdef81u
                        : (lane == 1u ? 0x1234007fu : 0x010203f0u);
    case 1:
      return lane == 0u ? 0xface8123u
                        : (lane == 1u ? 0x44447ff0u : 0x0000ff02u);
    case 2:
      return 0x72000000u + static_cast<std::uint32_t>(lane);
    case 3:
      return 0x73000000u + static_cast<std::uint32_t>(lane << 4) +
             static_cast<std::uint32_t>(word_index);
    case 4:
      return 0x74000000u + static_cast<std::uint32_t>(lane << 4) +
             static_cast<std::uint32_t>(word_index);
    case 5:
      return 0x75000000u + static_cast<std::uint32_t>(lane << 4) +
             static_cast<std::uint32_t>(word_index);
    default:
      return 0u;
  }
...
std::uint32_t ExpectedDsStoreMemoryWord(std::size_t case_index,
                                        std::size_t word_index,
                                        std::size_t lane) {
  const std::uint32_t initial =
      InitialDsStoreMemoryWord(case_index, word_index, lane);
  if (!IsDsLaneActive(lane)) {
    return initial;
  }

  const std::uint32_t source =
      InitialDsStoreSourceWord(case_index, word_index, lane);
  if (case_index == 0u) {
    return (initial & 0xffffff00u) | (source & 0xffu);
  }
  if (case_index == 1u) {
    return (initial & 0xffff0000u) | (source & 0xffffu);
  }
  return source;
}
...
std::uint64_t InitialDsWideOldValue(std::size_t case_index, std::size_t lane) {
  ...
  switch (normalized_case_index) {
    ...
    case 4:
      return lane == 0u ? 10ull
                        : (lane == 1u ? 100ull : 0xfffffffffffffff0ull);
    case 5:
      return lane == 0u ? 20ull : (lane == 1u ? 5ull : 1ull);
    case 6:
      return lane == 0u ? 4ull : (lane == 1u ? 10ull : 1ull);
    case 7:
      return lane == 0u ? 4ull : (lane == 1u ? 3ull : 8ull);
    case 8:
      return lane == 0u ? 0ull : (lane == 1u ? 5ull : 4ull);
    case 9:
      return lane == 0u ? I64Bits(-5ll)
                        : (lane == 1u ? 9ull : I64Bits(-1ll));
    case 10:
      return lane == 0u ? 5ull : (lane == 1u ? 9ull : 0xfffffffffffffff0ull);
    case 11:
      return lane == 0u ? I64Bits(-5ll)
                        : (lane == 1u ? 9ull : I64Bits(-1ll));
    case 12:
    ...
    case 13:
      return lane == 0u ? 0x0f0f00f00f0f00f0ull
                        : (lane == 1u ? 0xff00ff00ff00ff00ull
                                       : 0xaaaaaaaa55555555ull);
    case 14:
      return lane == 0u ? 0x000000f0000000f0ull
                        : (lane == 1u ? 0x00ff000000ff0000ull
                                       : 0x0f000f000f000f00ull);
    case 15:
      return lane == 0u ? 0xaaaa5555aaaa5555ull
                        : (lane == 1u ? 0x123456789abcdef0ull
                                       : 0xffffffffffffffffull);
    default:
      return 0u;
  }
...
std::uint64_t InitialDsWideDataValue(std::size_t case_index, std::size_t lane) {
  ...
  switch (normalized_case_index) {
    ...
    case 4:
      return lane == 0u ? 5ull : (lane == 1u ? 7ull : 0x20ull);
    case 5:
      return lane == 0u ? 3ull : (lane == 1u ? 7ull : 2ull);
    case 6:
      return lane == 0u ? 7ull : (lane == 1u ? 6ull : 1ull);
    case 7:
      return 4ull;
    case 8:
      return 4ull;
    case 9:
      return lane == 0u ? I64Bits(-2ll)
                        : (lane == 1u ? I64Bits(-4ll) : 7ull);
    case 10:
      return lane == 0u ? 2ull : (lane == 1u ? 10ull : 0x10ull);
    case 11:
      return lane == 0u ? I64Bits(-2ll)
                        : (lane == 1u ? I64Bits(-4ll) : 7ull);
    case 12:
...
std::uint32_t InitialDsLoadDestValue(std::size_t case_index,
                                     std::size_t component,
                                     std::size_t lane) {
  return 0xd5000000u + static_cast<std::uint32_t>(case_index << 12) +
         static_cast<std::uint32_t>(component << 8) +
         static_cast<std::uint32_t>(lane);
}

std::uint32_t ExpectedDsLoadWord(std::size_t case_index,
                                 std::size_t lane,
                                 std::size_t word_index) {
  switch (case_index) {
    case 0:
      return 0x31000000u + static_cast<std::uint32_t>(lane);
    case 1:
      return 0x32000000u + static_cast<std::uint32_t>(lane << 4) +
             static_cast<std::uint32_t>(word_index);
    case 2:
      return 0x33000000u + static_cast<std::uint32_t>(lane << 4) +
             static_cast<std::uint32_t>(word_index);
    case 3:
      return 0x34000000u + static_cast<std::uint32_t>(lane << 4) +
             static_cast<std::uint32_t>(word_index);
    default:
      return 0u;
  }
...
std::uint8_t DsLoadBytePayload(std::size_t case_index, std::size_t lane) {
  switch (case_index) {
    case 4:
    case 5:
      return lane == 0u ? 0x81u : (lane == 1u ? 0x7fu : 0xf0u);
    default:
      return 0u;
  }
}

std::uint16_t DsLoadHalfPayload(std::size_t case_index, std::size_t lane) {
  switch (case_index) {
    case 6:
    case 7:
      return lane == 0u ? 0x8123u : (lane == 1u ? 0x7ff0u : 0xff02u);
    default:
      return 0u;
  }
}

std::uint32_t ExpectedDsLoadScalarValue(std::size_t case_index,
                                        std::size_t lane) {
  if (case_index == 4u) {
    return static_cast<std::uint32_t>(static_cast<std::int32_t>(
        static_cast<std::int8_t>(DsLoadBytePayload(case_index, lane))));
  }
  if (case_index == 5u) {
    return static_cast<std::uint32_t>(DsLoadBytePayload(case_index, lane));
  }
  if (case_index == 6u) {
    return static_cast<std::uint32_t>(static_cast<std::int32_t>(
        static_cast<std::int16_t>(DsLoadHalfPayload(case_index, lane))));
  }
  return static_cast<std::uint32_t>(DsLoadHalfPayload(case_index, lane));
}

std::uint32_t InitialDsLoadD16DestValue(std::size_t case_index,
                                        std::size_t lane) {
  return 0xdb000000u + static_cast<std::uint32_t>(case_index << 12) +
         static_cast<std::uint32_t>(lane);
}

std::uint8_t DsLoadD16BytePayload(std::size_t case_index, std::size_t lane) {
  switch (case_index) {
    case 0:
    case 1:
      return lane == 0u ? 0x81u : (lane == 1u ? 0x7fu : 0xf0u);
    case 2:
    case 3:
      return lane == 0u ? 0x82u : (lane == 1u ? 0x7eu : 0xf1u);
    default:
      return 0u;
  }
}

std::uint16_t DsLoadD16HalfPayload(std::size_t case_index, std::size_t lane) {
  switch (case_index) {
    case 4:
    case 5:
      return lane == 0u ? 0x8123u : (lane == 1u ? 0x7ff0u : 0xff02u);
...
std::uint16_t ExpectedDsLoadD16Payload(std::size_t case_index,
                                       std::size_t lane) {
  const DsLoadD16Case& ds_case = kDsLoadD16Cases[case_index];
  if (ds_case.byte_load) {
    const std::uint8_t value = DsLoadD16BytePayload(case_index, lane);
    return ds_case.sign_extend
               ? static_cast<std::uint16_t>(static_cast<std::int16_t>(
                     static_cast<std::int8_t>(value)))
               : static_cast<std::uint16_t>(value);
  }
  return DsLoadD16HalfPayload(case_index, lane);
}

std::uint32_t ExpectedDsLoadD16DestValue(std::size_t case_index,
                                         std::size_t lane) {
  const std::uint32_t initial = InitialDsLoadD16DestValue(case_index, lane);
  if (!IsDsLaneActive(lane)) {
    return initial;
  }

  const std::uint32_t payload = ExpectedDsLoadD16Payload(case_index, lane);
  return kDsLoadD16Cases[case_index].high_half
             ? ((initial & 0x0000ffffu) | (payload << 16))
             : ((initial & 0xffff0000u) | payload);
}

std::uint32_t InitialDsStoreD16MemoryWord(std::size_t case_index,
                                          std::size_t lane) {
  return 0xe9000000u + static_cast<std::uint32_t>(case_index << 12) +
         static_cast<std::uint32_t>(lane);
}

std::uint32_t InitialDsStoreD16SourceValue(std::size_t case_index,
                                           std::size_t lane) {
  switch (case_index) {
    case 0:
      return lane == 0u ? 0xface8123u
                        : (lane == 1u ? 0x44447ff0u : 0x12ab3400u);
    case 1:
      return lane == 0u ? 0xbeef1234u
                        : (lane == 1u ? 0x89ab5678u : 0xcdef0001u);
    default:
      return 0u;
  }
}

std::uint32_t ExpectedDsStoreD16MemoryWord(std::size_t case_index,
                                           std::size_t lane) {
  const std::uint32_t initial = InitialDsStoreD16MemoryWord(case_index, lane);
  if (!IsDsLaneActive(lane)) {
    return initial;
  }

  const std::uint32_t source = InitialDsStoreD16SourceValue(case_index, lane);
  return kDsStoreD16Cases[case_index].byte_store
             ? ((initial & 0xffffff00u) | ((source >> 16) & 0xffu))
             : ((initial & 0xffff0000u) | ((source >> 16) & 0xffffu));
}
...
bool RunDsRtnBatchTest(
  ...
  std::vector<std::uint32_t> ds_program_words;
  ds_program_words.reserve((kDsRtnCases.size() + 1u) * 2u + 1u);
  const auto ds_nop_words = MakeDs(20u, 0u, 0u, 0u, 0u, 0u);
  ds_program_words.push_back(ds_nop_words[0]);
  ds_program_words.push_back(ds_nop_words[1]);
  for (const DsRtnCase& ds_case : kDsRtnCases) {
  ...
  std::vector<DecodedInstruction> ds_program;
  if (!Expect(decoder.DecodeProgram(ds_program_words, &ds_program, error_message),
              "expected DS return batch decode success") ||
      !Expect(ds_program.size() == kDsRtnCases.size() + 2u,
              "expected decoded DS return instruction count") ||
      !Expect(ds_program.front().opcode == "DS_NOP",
              "expected decoded DS_NOP at return batch start")) {
    return false;
  }
  for (std::size_t i = 0; i < kDsRtnCases.size(); ++i) {
    if (!Expect(ds_program[i + 1u].opcode == kDsRtnCases[i].opcode,
                "expected decoded DS return opcode order")) {
      return false;
    }
  }
  if (!Expect(ds_program.back().opcode == "S_ENDPGM",
              "expected decoded S_ENDPGM after DS return batch")) {
    return false;
  }
  ...
  auto initialize_ds_state = [](WaveExecutionState* state) {
    state->exec_mask = kDsExecMask;
    for (std::size_t lane = 0; lane < 32u; ++lane) {
      for (std::size_t case_index = 0; case_index < kDsRtnCases.size();
           ++case_index) {
        state->vgprs[kDsRtnCases[case_index].dest][lane] =
            0xacce0000u + static_cast<std::uint32_t>(case_index << 8) +
            static_cast<std::uint32_t>(lane);
        state->vgprs[kDsRtnCases[case_index].addr][lane] =
            static_cast<std::uint32_t>(DsCaseBaseAddress(case_index) + 0x2000u +
                                       lane * 4u);
        state->vgprs[kDsRtnCases[case_index].data][lane] =
            InitialDsDataValue(case_index, lane);
      }
    }
  };
  ...
  auto expect_ds_state = [](const WaveExecutionState& state) {
    if (!(state.lane_count == 32u && state.exec_mask == kDsExecMask &&
          state.halted && !state.waiting_on_barrier &&
          state.pc == kDsRtnCases.size() + 1u)) {
      return false;
    }
    for (std::size_t lane = 0; lane < 32u; ++lane) {
      for (std::size_t case_index = 0; case_index < kDsRtnCases.size();
           ++case_index) {
        if (state.vgprs[kDsRtnCases[case_index].addr][lane] !=
            static_cast<std::uint32_t>(DsCaseBaseAddress(case_index) + 0x2000u +
                                       lane * 4u)) {
          return false;
        }
        if (state.vgprs[kDsRtnCases[case_index].data][lane] !=
            InitialDsDataValue(case_index, lane)) {
          return false;
        }
        const std::uint32_t expected_dest =
            IsDsLaneActive(lane)
                ? InitialDsOldValue(case_index, lane)
                : 0xacce0000u + static_cast<std::uint32_t>(case_index << 8) +
                      static_cast<std::uint32_t>(lane);
        if (state.vgprs[kDsRtnCases[case_index].dest][lane] != expected_dest) {
          return false;
        }
      }
    }
  ...
  auto initialize_ds_memory = [](LinearExecutionMemory* memory) {
    for (std::size_t case_index = 0; case_index < kDsRtnCases.size();
      ...
      for (std::size_t lane = 0; lane < 32u; ++lane) {
        const std::uint64_t address =
            DsCaseBaseAddress(case_index) + 0x2000u +
            kDsRtnCases[case_index].offset + lane * 4u;
        if (!memory->StoreU32(address, InitialDsOldValue(case_index, lane))) {
          return false;
        }
      }
  ...
  LinearExecutionMemory decoded_ds_memory(0x4000u, kDsBaseAddress);
  if (!Expect(initialize_ds_memory(&decoded_ds_memory),
              "expected DS return decoded memory initialization")) {
    return false;
  }
  WaveExecutionState decoded_ds_state;
  initialize_ds_state(&decoded_ds_state);
  if (!Expect(interpreter.ExecuteProgram(ds_program, &decoded_ds_state,
                                         &decoded_ds_memory, error_message),
              "expected decoded DS return execution success") ||
      !Expect(expect_ds_state(decoded_ds_state),
              "expected decoded DS return state") ||
      !Expect(expect_ds_memory(&decoded_ds_memory),
              "expected decoded DS return memory state")) {
    return false;
  }
  ...
  if (!Expect(interpreter.CompileProgram(ds_program, &compiled_ds_program,
                                         error_message),
              "expected compiled DS return program success") ||
      !Expect(compiled_ds_program.size() == kDsRtnCases.size() + 2u,
              "expected compiled DS return instruction count") ||
      !Expect(compiled_ds_program.front().opcode == Gfx1201CompiledOpcode::kSNop,
              "expected compiled DS return NOP as kSNop")) {
    return false;
  }
  for (std::size_t i = 0; i < kDsRtnCases.size(); ++i) {
    if (!Expect(compiled_ds_program[i + 1u].opcode == kDsRtnCases[i].compiled,
                "expected compiled DS return opcode order")) {
      return false;
    }
  }
  if (!Expect(compiled_ds_program.back().opcode ==
                  Gfx1201CompiledOpcode::kSEndpgm,
              "expected compiled S_ENDPGM after DS return batch")) {
    return false;
  }

  LinearExecutionMemory compiled_ds_memory(0x4000u, kDsBaseAddress);
  if (!Expect(initialize_ds_memory(&compiled_ds_memory),
              "expected DS return compiled memory initialization")) {
    return false;
  }
  WaveExecutionState compiled_ds_state;
  initialize_ds_state(&compiled_ds_state);
  if (!Expect(interpreter.ExecuteProgram(compiled_ds_program,
                                         ...
                                         &compiled_ds_memory,
                                         error_message),
              "expected compiled DS return execution success") ||
      !Expect(expect_ds_state(compiled_ds_state),
...
bool RunDsLoadBatchTest(
  ...
  std::vector<std::uint32_t> ds_program_words;
  ds_program_words.reserve((kDsLoadCases.size() + 1u) * 2u + 1u);
  const auto ds_nop_words = MakeDs(20u, 0u, 0u, 0u, 0u, 0u);
  ds_program_words.push_back(ds_nop_words[0]);
  ds_program_words.push_back(ds_nop_words[1]);
  for (const DsLoadCase& ds_case : kDsLoadCases) {
    const auto words = MakeDs(ds_case.op, ds_case.dest, ds_case.addr, 0u, 0u,
                              ds_case.offset);
    ds_program_words.push_back(words[0]);
    ds_program_words.push_back(words[1]);
  }
  ...
  std::vector<DecodedInstruction> ds_program;
  if (!Expect(decoder.DecodeProgram(ds_program_words, &ds_program, error_message),
              "expected DS load batch decode success") ||
      !Expect(ds_program.size() == kDsLoadCases.size() + 2u,
              "expected decoded DS load instruction count") ||
      !Expect(ds_program.front().opcode == "DS_NOP",
              "expected decoded DS_NOP at load batch start")) {
    return false;
  }
  for (std::size_t i = 0; i < kDsLoadCases.size(); ++i) {
    if (!Expect(ds_program[i + 1u].opcode == kDsLoadCases[i].opcode,
                "expected decoded DS load opcode order")) {
      return false;
    }
  }
  if (!Expect(ds_program.back().opcode == "S_ENDPGM",
              "expected decoded S_ENDPGM after DS load batch")) {
    return false;
  }
  ...
  auto initialize_ds_state = [](WaveExecutionState* state) {
    state->exec_mask = kDsExecMask;
    for (std::size_t lane = 0; lane < 32u; ++lane) {
      for (std::size_t case_index = 0; case_index < kDsLoadCases.size();
           ++case_index) {
        const std::size_t word_count = DsLoadWordCount(case_index);
        for (std::size_t word_index = 0; word_index < word_count; ++word_index) {
          state->vgprs[kDsLoadCases[case_index].dest + word_index][lane] =
              InitialDsLoadDestValue(case_index, word_index, lane);
        }
        state->vgprs[kDsLoadCases[case_index].addr][lane] =
            static_cast<std::uint32_t>(DsLoadLaneBaseAddress(case_index, lane));
      }
    }
  };
  ...
  auto expect_ds_state = [](const WaveExecutionState& state) {
    if (!(state.lane_count == 32u && state.exec_mask == kDsExecMask &&
          state.halted && !state.waiting_on_barrier &&
          state.pc == kDsLoadCases.size() + 1u)) {
      return false;
    }
    for (std::size_t lane = 0; lane < 32u; ++lane) {
      for (std::size_t case_index = 0; case_index < kDsLoadCases.size();
           ++case_index) {
        if (state.vgprs[kDsLoadCases[case_index].addr][lane] !=
            static_cast<std::uint32_t>(DsLoadLaneBaseAddress(case_index, lane))) {
          return false;
        }
        const std::size_t word_count = DsLoadWordCount(case_index);
        for (std::size_t word_index = 0; word_index < word_count; ++word_index) {
          const std::uint32_t expected_value =
              IsDsLaneActive(lane)
                  ? (case_index < 4u
                         ? ExpectedDsLoadWord(case_index, lane, word_index)
                         : ExpectedDsLoadScalarValue(case_index, lane))
                  : InitialDsLoadDestValue(case_index, word_index, lane);
          if (state.vgprs[kDsLoadCases[case_index].dest + word_index][lane] !=
              expected_value) {
            return false;
          }
        }
  ...
  auto initialize_ds_memory = [](LinearExecutionMemory* memory) {
    for (std::size_t case_index = 0; case_index < kDsLoadCases.size();
      ...
      for (std::size_t lane = 0; lane < 32u; ++lane) {
        const std::uint64_t address =
            DsLoadLaneBaseAddress(case_index, lane) + kDsLoadCases[case_index].offset;
        if (case_index < 4u) {
          const std::size_t word_count = DsLoadWordCount(case_index);
          for (std::size_t word_index = 0; word_index < word_count; ++word_index) {
            if (!memory->StoreU32(
                    address + static_cast<std::uint64_t>(word_index * 4u),
                    ExpectedDsLoadWord(case_index, lane, word_index))) {
              return false;
            }
          }
        } else if (case_index < 6u) {
          if (!memory->StoreU8(address, DsLoadBytePayload(case_index, lane))) {
            return false;
          }
        } else {
          if (!memory->StoreU16(address, DsLoadHalfPayload(case_index, lane))) {
            return false;
          }
        }
      }
        ...
        if (case_index < 4u) {
          ...
          for (std::size_t word_index = 0; word_index < word_count; ++word_index) {
            ...
            if (!memory->LoadU32(
                    address + static_cast<std::uint64_t>(word_index * 4u),
                    &value) ||
                value != ExpectedDsLoadWord(case_index, lane, word_index)) {
              return false;
            }
          }
        } else if (case_index < 6u) {
          ...
          if (!memory->LoadU8(address, &value) ||
              value != DsLoadBytePayload(case_index, lane)) {
            return false;
          }
        } else {
          std::uint16_t value = 0;
          if (!memory->LoadU16(address, &value) ||
              value != DsLoadHalfPayload(case_index, lane)) {
            return false;
          }
        }
      }
  ...
  LinearExecutionMemory decoded_ds_memory(0x8000u, kDsLoadBaseAddress);
  if (!Expect(initialize_ds_memory(&decoded_ds_memory),
              "expected DS load decoded memory initialization")) {
    return false;
  }
  WaveExecutionState decoded_ds_state;
  initialize_ds_state(&decoded_ds_state);
  if (!Expect(interpreter.ExecuteProgram(ds_program, &decoded_ds_state,
                                         &decoded_ds_memory, error_message),
              "expected decoded DS load execution success") ||
      !Expect(expect_ds_state(decoded_ds_state),
              "expected decoded DS load state") ||
      !Expect(expect_ds_memory(&decoded_ds_memory),
              "expected decoded DS load memory state")) {
    return false;
  }
  ...
  if (!Expect(interpreter.CompileProgram(ds_program, &compiled_ds_program,
                                         error_message),
              "expected compiled DS load program success") ||
      !Expect(compiled_ds_program.size() == kDsLoadCases.size() + 2u,
              "expected compiled DS load instruction count") ||
      !Expect(compiled_ds_program.front().opcode == Gfx1201CompiledOpcode::kSNop,
              "expected compiled DS load NOP as kSNop")) {
    return false;
  }
  for (std::size_t i = 0; i < kDsLoadCases.size(); ++i) {
    if (!Expect(compiled_ds_program[i + 1u].opcode == kDsLoadCases[i].compiled,
                "expected compiled DS load opcode order")) {
      return false;
    }
  }
  if (!Expect(compiled_ds_program.back().opcode ==
                  Gfx1201CompiledOpcode::kSEndpgm,
              "expected compiled S_ENDPGM after DS load batch")) {
    return false;
  }

  LinearExecutionMemory compiled_ds_memory(0x8000u, kDsLoadBaseAddress);
  if (!Expect(initialize_ds_memory(&compiled_ds_memory),
              "expected DS load compiled memory initialization")) {
    return false;
  }
  WaveExecutionState compiled_ds_state;
  initialize_ds_state(&compiled_ds_state);
  if (!Expect(interpreter.ExecuteProgram(compiled_ds_program,
                                         ...
                                         &compiled_ds_memory,
                                         error_message),
              "expected compiled DS load execution success") ||
      !Expect(expect_ds_state(compiled_ds_state),
              "expected compiled DS load state") ||
      !Expect(expect_ds_memory(&compiled_ds_memory),
              "expected compiled DS load memory state")) {
    return false;
  }
...
bool RunDsStoreBatchTest(
  ...
  std::vector<std::uint32_t> ds_program_words;
  ds_program_words.reserve((kDsStoreCases.size() + 1u) * 2u + 1u);
  const auto ds_nop_words = MakeDs(20u, 0u, 0u, 0u, 0u, 0u);
  ds_program_words.push_back(ds_nop_words[0]);
  ds_program_words.push_back(ds_nop_words[1]);
  for (const DsStoreCase& ds_case : kDsStoreCases) {
    const auto words =
        MakeDs(ds_case.op, 0u, ds_case.addr, ds_case.data, 0u, ds_case.offset);
    ds_program_words.push_back(words[0]);
    ds_program_words.push_back(words[1]);
  ...
  std::vector<DecodedInstruction> ds_program;
  if (!Expect(decoder.DecodeProgram(ds_program_words, &ds_program, error_message),
              "expected DS store batch decode success") ||
      !Expect(ds_program.size() == kDsStoreCases.size() + 2u,
              "expected decoded DS store instruction count") ||
      !Expect(ds_program.front().opcode == "DS_NOP",
              "expected decoded DS_NOP at store batch start")) {
    return false;
  }
  for (std::size_t i = 0; i < kDsStoreCases.size(); ++i) {
    if (!Expect(ds_program[i + 1u].opcode == kDsStoreCases[i].opcode,
                "expected decoded DS store opcode order")) {
      return false;
    }
  }
  if (!Expect(ds_program.back().opcode == "S_ENDPGM",
              "expected decoded S_ENDPGM after DS store batch")) {
    return false;
  }
  ...
  auto initialize_ds_state = [](WaveExecutionState* state) {
    state->exec_mask = kDsExecMask;
    for (std::size_t lane = 0; lane < 32u; ++lane) {
      for (std::size_t case_index = 0; case_index < kDsStoreCases.size();
           ++case_index) {
        const std::size_t word_count = DsStoreWordCount(case_index);
        for (std::size_t word_index = 0; word_index < word_count;
             ++word_index) {
          state->vgprs[kDsStoreCases[case_index].data + word_index][lane] =
              InitialDsStoreSourceWord(case_index, word_index, lane);
        }
        state->vgprs[kDsStoreCases[case_index].addr][lane] =
            static_cast<std::uint32_t>(DsStoreLaneBaseAddress(case_index, lane));
      }
    }
  };
  ...
  auto expect_ds_state = [](const WaveExecutionState& state) {
    if (!(state.lane_count == 32u && state.exec_mask == kDsExecMask &&
          state.halted && !state.waiting_on_barrier &&
          state.pc == kDsStoreCases.size() + 1u)) {
      return false;
    }
    for (std::size_t lane = 0; lane < 32u; ++lane) {
      for (std::size_t case_index = 0; case_index < kDsStoreCases.size();
           ++case_index) {
        if (state.vgprs[kDsStoreCases[case_index].addr][lane] !=
            static_cast<std::uint32_t>(
                DsStoreLaneBaseAddress(case_index, lane))) {
          return false;
        }
        const std::size_t word_count = DsStoreWordCount(case_index);
        for (std::size_t word_index = 0; word_index < word_count;
             ++word_index) {
          if (state.vgprs[kDsStoreCases[case_index].data + word_index][lane] !=
              InitialDsStoreSourceWord(case_index, word_index, lane)) {
            return false;
          }
        }
  ...
  auto initialize_ds_memory = [](LinearExecutionMemory* memory) {
    for (std::size_t case_index = 0; case_index < kDsStoreCases.size();
         ++case_index) {
      for (std::size_t lane = 0; lane < 32u; ++lane) {
        const std::uint64_t address = DsStoreLaneBaseAddress(case_index, lane) +
                                      kDsStoreCases[case_index].offset;
        const std::size_t word_count = DsStoreWordCount(case_index);
        for (std::size_t word_index = 0; word_index < word_count;
             ++word_index) {
          if (!memory->StoreU32(address + static_cast<std::uint64_t>(word_index * 4u),
                                InitialDsStoreMemoryWord(case_index, word_index,
                                                         lane))) {
            return false;
          }
        }
    ...
    for (std::size_t case_index = 0; case_index < kDsStoreCases.size();
      ...
      for (std::size_t lane = 0; lane < 32u; ++lane) {
        ...
        for (std::size_t word_index = 0; word_index < word_count;
             ++word_index) {
          std::uint32_t value = 0;
          if (!memory->LoadU32(address + static_cast<std::uint64_t>(word_index * 4u),
                               &value) ||
              value !=
                  ExpectedDsStoreMemoryWord(case_index, word_index, lane)) {
            return false;
          }
        }
      }
  ...
  LinearExecutionMemory decoded_ds_memory(0x8000u, kDsStoreBaseAddress);
  if (!Expect(initialize_ds_memory(&decoded_ds_memory),
              "expected DS store decoded memory initialization")) {
    return false;
  }
  WaveExecutionState decoded_ds_state;
  initialize_ds_state(&decoded_ds_state);
  if (!Expect(interpreter.ExecuteProgram(ds_program, &decoded_ds_state,
                                         &decoded_ds_memory, error_message),
              "expected decoded DS store execution success") ||
      !Expect(expect_ds_state(decoded_ds_state),
              "expected decoded DS store state") ||
      !Expect(expect_ds_memory(&decoded_ds_memory),
              "expected decoded DS store memory state")) {
    return false;
  }
  ...
  if (!Expect(interpreter.CompileProgram(ds_program, &compiled_ds_program,
                                         error_message),
              "expected compiled DS store program success") ||
      !Expect(compiled_ds_program.size() == kDsStoreCases.size() + 2u,
              "expected compiled DS store instruction count") ||
      !Expect(compiled_ds_program.front().opcode ==
                  Gfx1201CompiledOpcode::kSNop,
              "expected compiled DS store NOP as kSNop")) {
    return false;
  }
  for (std::size_t i = 0; i < kDsStoreCases.size(); ++i) {
    if (!Expect(compiled_ds_program[i + 1u].opcode == kDsStoreCases[i].compiled,
                "expected compiled DS store opcode order")) {
      return false;
    }
  }
  if (!Expect(compiled_ds_program.back().opcode ==
                  Gfx1201CompiledOpcode::kSEndpgm,
              "expected compiled S_ENDPGM after DS store batch")) {
    return false;
  }

  LinearExecutionMemory compiled_ds_memory(0x8000u, kDsStoreBaseAddress);
  if (!Expect(initialize_ds_memory(&compiled_ds_memory),
              "expected DS store compiled memory initialization")) {
    return false;
  }
  WaveExecutionState compiled_ds_state;
  initialize_ds_state(&compiled_ds_state);
  if (!Expect(interpreter.ExecuteProgram(compiled_ds_program,
                                         ...
                                         &compiled_ds_memory,
                                         error_message),
              "expected compiled DS store execution success") ||
      !Expect(expect_ds_state(compiled_ds_state),
              "expected compiled DS store state") ||
      !Expect(expect_ds_memory(&compiled_ds_memory),
              "expected compiled DS store memory state")) {
    return false;
  }
...
bool RunDsLoadD16BatchTest(
  ...
  std::vector<std::uint32_t> ds_program_words;
  ds_program_words.reserve((kDsLoadD16Cases.size() + 1u) * 2u + 1u);
  const auto ds_nop_words = MakeDs(20u, 0u, 0u, 0u, 0u, 0u);
  ds_program_words.push_back(ds_nop_words[0]);
  ds_program_words.push_back(ds_nop_words[1]);
  for (const DsLoadD16Case& ds_case : kDsLoadD16Cases) {
    const auto words =
        MakeDs(ds_case.op, ds_case.dest, ds_case.addr, 0u, 0u, ds_case.offset);
    ds_program_words.push_back(words[0]);
    ds_program_words.push_back(words[1]);
  }
  ds_program_words.push_back(MakeSopp(48u));
  ...
  std::vector<DecodedInstruction> ds_program;
  if (!Expect(decoder.DecodeProgram(ds_program_words, &ds_program, error_message),
              "expected DS D16 load batch decode success") ||
      !Expect(ds_program.size() == kDsLoadD16Cases.size() + 2u,
              "expected decoded DS D16 load instruction count") ||
      !Expect(ds_program.front().opcode == "DS_NOP",
              "expected decoded DS_NOP at D16 load batch start")) {
    return false;
  }
  for (std::size_t i = 0; i < kDsLoadD16Cases.size(); ++i) {
    if (!Expect(ds_program[i + 1u].opcode == kDsLoadD16Cases[i].opcode,
                "expected decoded DS D16 load opcode order")) {
      return false;
    }
  }
  if (!Expect(ds_program.back().opcode == "S_ENDPGM",
              "expected decoded S_ENDPGM after DS D16 load batch")) {
    return false;
  }
  ...
  auto initialize_ds_state = [](WaveExecutionState* state) {
    state->exec_mask = kDsExecMask;
    for (std::size_t lane = 0; lane < 32u; ++lane) {
      for (std::size_t case_index = 0; case_index < kDsLoadD16Cases.size();
           ++case_index) {
        state->vgprs[kDsLoadD16Cases[case_index].dest][lane] =
            InitialDsLoadD16DestValue(case_index, lane);
        state->vgprs[kDsLoadD16Cases[case_index].addr][lane] =
            static_cast<std::uint32_t>(
                DsLoadD16LaneBaseAddress(case_index, lane));
      }
    }
  };
  ...
  auto expect_ds_state = [](const WaveExecutionState& state) {
    if (!(state.lane_count == 32u && state.exec_mask == kDsExecMask &&
          state.halted && !state.waiting_on_barrier &&
          state.pc == kDsLoadD16Cases.size() + 1u)) {
      return false;
    }
    for (std::size_t lane = 0; lane < 32u; ++lane) {
      for (std::size_t case_index = 0; case_index < kDsLoadD16Cases.size();
           ++case_index) {
        if (state.vgprs[kDsLoadD16Cases[case_index].addr][lane] !=
            static_cast<std::uint32_t>(
                DsLoadD16LaneBaseAddress(case_index, lane))) {
          return false;
        }
        if (state.vgprs[kDsLoadD16Cases[case_index].dest][lane] !=
            ExpectedDsLoadD16DestValue(case_index, lane)) {
          return false;
        }
      }
    }
  ...
  auto initialize_ds_memory = [](LinearExecutionMemory* memory) {
    for (std::size_t case_index = 0; case_index < kDsLoadD16Cases.size();
         ++case_index) {
      for (std::size_t lane = 0; lane < 32u; ++lane) {
        const std::uint64_t address = DsLoadD16LaneBaseAddress(case_index, lane) +
                                      kDsLoadD16Cases[case_index].offset;
        if (kDsLoadD16Cases[case_index].byte_load) {
          if (!memory->StoreU8(address, DsLoadD16BytePayload(case_index, lane))) {
            return false;
          }
        } else {
          if (!memory->StoreU16(address,
                                DsLoadD16HalfPayload(case_index, lane))) {
            return false;
          }
        }
      }
    ...
    for (std::size_t case_index = 0; case_index < kDsLoadD16Cases.size();
      ...
      for (std::size_t lane = 0; lane < 32u; ++lane) {
        ...
        if (kDsLoadD16Cases[case_index].byte_load) {
          std::uint8_t value = 0;
          if (!memory->LoadU8(address, &value) ||
              value != DsLoadD16BytePayload(case_index, lane)) {
            return false;
          }
        } else {
          std::uint16_t value = 0;
          if (!memory->LoadU16(address, &value) ||
              value != DsLoadD16HalfPayload(case_index, lane)) {
            return false;
          }
        }
      }
  ...
  LinearExecutionMemory decoded_ds_memory(0x8000u, kDsLoadD16BaseAddress);
  if (!Expect(initialize_ds_memory(&decoded_ds_memory),
              "expected DS D16 load decoded memory initialization")) {
    return false;
  }
  WaveExecutionState decoded_ds_state;
  initialize_ds_state(&decoded_ds_state);
  if (!Expect(interpreter.ExecuteProgram(ds_program, &decoded_ds_state,
                                         &decoded_ds_memory, error_message),
              "expected decoded DS D16 load execution success") ||
      !Expect(expect_ds_state(decoded_ds_state),
              "expected decoded DS D16 load state") ||
      !Expect(expect_ds_memory(&decoded_ds_memory),
              "expected decoded DS D16 load memory state")) {
    return false;
  }
  ...
  if (!Expect(interpreter.CompileProgram(ds_program, &compiled_ds_program,
                                         error_message),
              "expected compiled DS D16 load program success") ||
      !Expect(compiled_ds_program.size() == kDsLoadD16Cases.size() + 2u,
              "expected compiled DS D16 load instruction count") ||
      !Expect(compiled_ds_program.front().opcode == Gfx1201CompiledOpcode::kSNop,
              "expected compiled DS D16 load NOP as kSNop")) {
    return false;
  }
  for (std::size_t i = 0; i < kDsLoadD16Cases.size(); ++i) {
    if (!Expect(compiled_ds_program[i + 1u].opcode ==
                    kDsLoadD16Cases[i].compiled,
                "expected compiled DS D16 load opcode order")) {
      return false;
    }
  }
  if (!Expect(compiled_ds_program.back().opcode ==
                  Gfx1201CompiledOpcode::kSEndpgm,
              "expected compiled S_ENDPGM after DS D16 load batch")) {
    return false;
  }

  LinearExecutionMemory compiled_ds_memory(0x8000u, kDsLoadD16BaseAddress);
  if (!Expect(initialize_ds_memory(&compiled_ds_memory),
              "expected DS D16 load compiled memory initialization")) {
    return false;
  }
  WaveExecutionState compiled_ds_state;
  initialize_ds_state(&compiled_ds_state);
  if (!Expect(interpreter.ExecuteProgram(compiled_ds_program,
                                         ...
                                         &compiled_ds_memory,
                                         error_message),
              "expected compiled DS D16 load execution success") ||
      !Expect(expect_ds_state(compiled_ds_state),
              "expected compiled DS D16 load state") ||
      !Expect(expect_ds_memory(&compiled_ds_memory),
              "expected compiled DS D16 load memory state")) {
    return false;
  }
...
bool RunDsStoreD16BatchTest(
  ...
  std::vector<std::uint32_t> ds_program_words;
  ds_program_words.reserve((kDsStoreD16Cases.size() + 1u) * 2u + 1u);
  const auto ds_nop_words = MakeDs(20u, 0u, 0u, 0u, 0u, 0u);
  ds_program_words.push_back(ds_nop_words[0]);
  ds_program_words.push_back(ds_nop_words[1]);
  for (const DsStoreD16Case& ds_case : kDsStoreD16Cases) {
    const auto words =
        MakeDs(ds_case.op, 0u, ds_case.addr, ds_case.data, 0u, ds_case.offset);
    ds_program_words.push_back(words[0]);
    ds_program_words.push_back(words[1]);
  ...
  std::vector<DecodedInstruction> ds_program;
  if (!Expect(decoder.DecodeProgram(ds_program_words, &ds_program, error_message),
              "expected DS D16 store batch decode success") ||
      !Expect(ds_program.size() == kDsStoreD16Cases.size() + 2u,
              "expected decoded DS D16 store instruction count") ||
      !Expect(ds_program.front().opcode == "DS_NOP",
              "expected decoded DS_NOP at D16 store batch start")) {
    return false;
  }
  for (std::size_t i = 0; i < kDsStoreD16Cases.size(); ++i) {
    if (!Expect(ds_program[i + 1u].opcode == kDsStoreD16Cases[i].opcode,
                "expected decoded DS D16 store opcode order")) {
      return false;
    }
  }
  if (!Expect(ds_program.back().opcode == "S_ENDPGM",
              "expected decoded S_ENDPGM after DS D16 store batch")) {
    return false;
  }
  ...
  auto initialize_ds_state = [](WaveExecutionState* state) {
    state->exec_mask = kDsExecMask;
    for (std::size_t lane = 0; lane < 32u; ++lane) {
      for (std::size_t case_index = 0; case_index < kDsStoreD16Cases.size();
           ++case_index) {
        state->vgprs[kDsStoreD16Cases[case_index].data][lane] =
            InitialDsStoreD16SourceValue(case_index, lane);
        state->vgprs[kDsStoreD16Cases[case_index].addr][lane] =
            static_cast<std::uint32_t>(
                DsStoreD16LaneBaseAddress(case_index, lane));
      }
    }
  };
  ...
  auto expect_ds_state = [](const WaveExecutionState& state) {
    if (!(state.lane_count == 32u && state.exec_mask == kDsExecMask &&
          state.halted && !state.waiting_on_barrier &&
          state.pc == kDsStoreD16Cases.size() + 1u)) {
      return false;
    }
    for (std::size_t lane = 0; lane < 32u; ++lane) {
      for (std::size_t case_index = 0; case_index < kDsStoreD16Cases.size();
           ++case_index) {
        if (state.vgprs[kDsStoreD16Cases[case_index].addr][lane] !=
            static_cast<std::uint32_t>(
                DsStoreD16LaneBaseAddress(case_index, lane))) {
          return false;
        }
        if (state.vgprs[kDsStoreD16Cases[case_index].data][lane] !=
            InitialDsStoreD16SourceValue(case_index, lane)) {
          return false;
        }
      }
  ...
  auto initialize_ds_memory = [](LinearExecutionMemory* memory) {
    for (std::size_t case_index = 0; case_index < kDsStoreD16Cases.size();
      ...
      for (std::size_t lane = 0; lane < 32u; ++lane) {
        const std::uint64_t address =
            DsStoreD16LaneBaseAddress(case_index, lane) +
            kDsStoreD16Cases[case_index].offset;
        if (!memory->StoreU32(address,
                              InitialDsStoreD16MemoryWord(case_index, lane))) {
          return false;
        }
      }
    }
  ...
  auto expect_ds_memory = [](LinearExecutionMemory* memory) {
    for (std::size_t case_index = 0; case_index < kDsStoreD16Cases.size();
      ...
      for (std::size_t lane = 0; lane < 32u; ++lane) {
        ...
        std::uint32_t value = 0;
        if (!memory->LoadU32(address, &value) ||
            value != ExpectedDsStoreD16MemoryWord(case_index, lane)) {
          return false;
        }
      }
    }
  ...
  LinearExecutionMemory decoded_ds_memory(0x4000u, kDsStoreD16BaseAddress);
  if (!Expect(initialize_ds_memory(&decoded_ds_memory),
              "expected DS D16 store decoded memory initialization")) {
    return false;
  }
  WaveExecutionState decoded_ds_state;
  initialize_ds_state(&decoded_ds_state);
  if (!Expect(interpreter.ExecuteProgram(ds_program, &decoded_ds_state,
                                         &decoded_ds_memory, error_message),
              "expected decoded DS D16 store execution success") ||
      !Expect(expect_ds_state(decoded_ds_state),
              "expected decoded DS D16 store state") ||
      !Expect(expect_ds_memory(&decoded_ds_memory),
              "expected decoded DS D16 store memory state")) {
    return false;
  }
  ...
  if (!Expect(interpreter.CompileProgram(ds_program, &compiled_ds_program,
                                         error_message),
              "expected compiled DS D16 store program success") ||
      !Expect(compiled_ds_program.size() == kDsStoreD16Cases.size() + 2u,
              "expected compiled DS D16 store instruction count") ||
      !Expect(compiled_ds_program.front().opcode ==
                  Gfx1201CompiledOpcode::kSNop,
              "expected compiled DS D16 store NOP as kSNop")) {
    return false;
  }
  for (std::size_t i = 0; i < kDsStoreD16Cases.size(); ++i) {
    if (!Expect(compiled_ds_program[i + 1u].opcode ==
                    kDsStoreD16Cases[i].compiled,
                "expected compiled DS D16 store opcode order")) {
      return false;
    }
  }
  if (!Expect(compiled_ds_program.back().opcode ==
                  Gfx1201CompiledOpcode::kSEndpgm,
              "expected compiled S_ENDPGM after DS D16 store batch")) {
    return false;
  }

  LinearExecutionMemory compiled_ds_memory(0x4000u, kDsStoreD16BaseAddress);
  if (!Expect(initialize_ds_memory(&compiled_ds_memory),
              "expected DS D16 store compiled memory initialization")) {
    return false;
  }
  WaveExecutionState compiled_ds_state;
  initialize_ds_state(&compiled_ds_state);
  if (!Expect(interpreter.ExecuteProgram(compiled_ds_program,
                                         ...
                                         &compiled_ds_memory,
                                         error_message),
              "expected compiled DS D16 store execution success") ||
      !Expect(expect_ds_state(compiled_ds_state),
