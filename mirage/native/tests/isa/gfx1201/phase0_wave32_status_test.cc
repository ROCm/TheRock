...
int main() {
  ...
  if (!Expect(smem->seeded_instruction_count == 28u,
      ...
      !Expect(vglobal->executable_instruction_count == 59u,
  ...
  if (!Expect(decoder.Phase0ExecutableOpcodes().size() == 412u,
  ...
  if (!Expect(smem->example_instruction == "S_LOAD_B32",
      ...
      !Expect(vglobal->first_executable_instruction == "GLOBAL_ATOMIC_ADD_U32",
