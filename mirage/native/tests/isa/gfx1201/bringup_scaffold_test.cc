...
int main() {
  ...
  if (!Expect(decoder.Phase0EncodingFocus().size() == 12u,
      ...
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MSKOR_RTN_B64"),
              "expected DS_MSKOR_RTN_B64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MSKOR_B64"),
              "expected DS_MSKOR_B64 executable decode support") ||
      ...
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_COND_SUB_U32"),
              "expected DS_COND_SUB_U32 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_SUB_CLAMP_RTN_U32"),
              "expected DS_SUB_CLAMP_RTN_U32 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_SUB_CLAMP_U32"),
      ...
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_LOAD_U8_D16"),
              "expected DS_LOAD_U8_D16 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_LOAD_U8_D16_HI"),
              "expected DS_LOAD_U8_D16_HI executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_LOAD_I8_D16"),
              "expected DS_LOAD_I8_D16 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_LOAD_I8_D16_HI"),
              "expected DS_LOAD_I8_D16_HI executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_LOAD_U16_D16"),
              "expected DS_LOAD_U16_D16 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_LOAD_U16_D16_HI"),
              "expected DS_LOAD_U16_D16_HI executable decode support") ||
      ...
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_STORE_B8_D16_HI"),
      ...
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MIN_NUM_RTN_F32"),
              "expected DS_MIN_NUM_RTN_F32 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MIN_NUM_F32"),
              "expected DS_MIN_NUM_F32 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MAX_NUM_RTN_F32"),
              "expected DS_MAX_NUM_RTN_F32 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MAX_NUM_F32"),
              "expected DS_MAX_NUM_F32 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MIN_NUM_RTN_F64"),
              "expected DS_MIN_NUM_RTN_F64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MIN_NUM_F64"),
              "expected DS_MIN_NUM_F64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MAX_NUM_RTN_F64"),
      ...
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_ADD_RTN_U64"),
              "expected DS_ADD_RTN_U64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_SUB_RTN_U64"),
              "expected DS_SUB_RTN_U64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_RSUB_RTN_U64"),
              "expected DS_RSUB_RTN_U64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_INC_RTN_U64"),
              "expected DS_INC_RTN_U64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_DEC_RTN_U64"),
              "expected DS_DEC_RTN_U64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MIN_RTN_I64"),
              "expected DS_MIN_RTN_I64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MIN_RTN_U64"),
              "expected DS_MIN_RTN_U64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MAX_RTN_I64"),
              "expected DS_MAX_RTN_I64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_MAX_RTN_U64"),
              "expected DS_MAX_RTN_U64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_AND_RTN_B64"),
              "expected DS_AND_RTN_B64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_OR_RTN_B64"),
              "expected DS_OR_RTN_B64 executable decode support") ||
      !Expect(decoder.SupportsPhase0ExecutableOpcode("DS_XOR_RTN_B64"),
              "expected DS_XOR_RTN_B64 executable decode support") ||
  ...
  const auto ds_load_u16_d16_hi_words =
      MakeDs(167u, 59u, 60u, 61u, 62u, 0x78u);
  if (!Expect(decoder.DecodeInstruction(
                  std::span<const std::uint32_t>(ds_load_u16_d16_hi_words.data(),
                                                 ds_load_u16_d16_hi_words.size()),
                  &decoded_instruction, &words_consumed, &error_message),
              "expected DS_LOAD_U16_D16_HI decode success") ||
      !Expect(words_consumed == 2u,
              "expected DS_LOAD_U16_D16_HI two dwords consumed") ||
      !Expect(decoded_instruction.opcode == "DS_LOAD_U16_D16_HI",
              "expected DS_LOAD_U16_D16_HI opcode") ||
      !Expect(decoded_instruction.operand_count == 3u,
              "expected DS_LOAD_U16_D16_HI three-operand decode") ||
      !Expect(decoded_instruction.operands[0].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[0].index == 59u,
              "expected DS_LOAD_U16_D16_HI destination VGPR") ||
      !Expect(decoded_instruction.operands[1].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[1].index == 60u,
              "expected DS_LOAD_U16_D16_HI address VGPR") ||
      !Expect(decoded_instruction.operands[2].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[2].imm32 == 0x78u,
              "expected DS_LOAD_U16_D16_HI offset0")) {
    return 1;
  }

  const auto ds_store_b16_d16_hi_words =
      MakeDs(161u, 59u, 60u, 61u, 62u, 0x35u);
  if (!Expect(decoder.DecodeInstruction(
                  std::span<const std::uint32_t>(
                      ds_store_b16_d16_hi_words.data(),
                      ds_store_b16_d16_hi_words.size()),
                  &decoded_instruction, &words_consumed, &error_message),
              "expected DS_STORE_B16_D16_HI decode success") ||
      !Expect(words_consumed == 2u,
              "expected DS_STORE_B16_D16_HI two dwords consumed") ||
      !Expect(decoded_instruction.opcode == "DS_STORE_B16_D16_HI",
              "expected DS_STORE_B16_D16_HI opcode") ||
      !Expect(decoded_instruction.operand_count == 3u,
              "expected DS_STORE_B16_D16_HI three-operand decode") ||
      !Expect(decoded_instruction.operands[0].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[0].index == 61u,
              "expected DS_STORE_B16_D16_HI data VGPR") ||
      !Expect(decoded_instruction.operands[1].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[1].index == 60u,
              "expected DS_STORE_B16_D16_HI address VGPR") ||
      !Expect(decoded_instruction.operands[2].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[2].imm32 == 0x35u,
              "expected DS_STORE_B16_D16_HI offset0")) {
    return 1;
  }
  ...
  if (!Expect(decoder.DecodeInstruction(
                  std::span<const std::uint32_t>(
                      ds_cond_sub_rtn_u32_words.data(),
                      ds_cond_sub_rtn_u32_words.size()),
                  &decoded_instruction, &words_consumed, &error_message),
              "expected DS_COND_SUB_RTN_U32 decode success") ||
      !Expect(words_consumed == 2u,
              "expected DS_COND_SUB_RTN_U32 two dwords consumed") ||
      !Expect(decoded_instruction.opcode == "DS_COND_SUB_RTN_U32",
              "expected DS_COND_SUB_RTN_U32 opcode") ||
      !Expect(decoded_instruction.operand_count == 5u,
              "expected DS_COND_SUB_RTN_U32 five-operand decode") ||
      !Expect(decoded_instruction.operands[0].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[0].index == 59u,
              "expected DS_COND_SUB_RTN_U32 destination VGPR") ||
      !Expect(decoded_instruction.operands[1].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[1].index == 60u,
              "expected DS_COND_SUB_RTN_U32 address VGPR") ||
      !Expect(decoded_instruction.operands[2].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[2].index == 61u,
              "expected DS_COND_SUB_RTN_U32 data VGPR") ||
      !Expect(decoded_instruction.operands[3].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[3].imm32 == 0x39u,
              "expected DS_COND_SUB_RTN_U32 offset0") ||
      !Expect(decoded_instruction.operands[4].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[4].imm32 == 0u,
              "expected DS_COND_SUB_RTN_U32 offset1")) {
    return 1;
  }
  ...
  const auto ds_mskor_rtn_b64_words =
      MakeDs(108u, 59u, 60u, 61u, 62u, 0x3cu);
  if (!Expect(decoder.DecodeInstruction(
                  std::span<const std::uint32_t>(ds_mskor_rtn_b64_words.data(),
                                                 ds_mskor_rtn_b64_words.size()),
                  &decoded_instruction, &words_consumed, &error_message),
              "expected DS_MSKOR_RTN_B64 decode success") ||
      !Expect(words_consumed == 2u,
              "expected DS_MSKOR_RTN_B64 two dwords consumed") ||
      !Expect(decoded_instruction.opcode == "DS_MSKOR_RTN_B64",
              "expected DS_MSKOR_RTN_B64 opcode") ||
      !Expect(decoded_instruction.operand_count == 6u,
              "expected DS_MSKOR_RTN_B64 six-operand decode") ||
      !Expect(decoded_instruction.operands[0].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[0].index == 59u,
              "expected DS_MSKOR_RTN_B64 destination VGPR") ||
      !Expect(decoded_instruction.operands[1].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[1].index == 60u,
              "expected DS_MSKOR_RTN_B64 address VGPR") ||
      !Expect(decoded_instruction.operands[2].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[2].index == 61u,
              "expected DS_MSKOR_RTN_B64 mask VGPR") ||
      !Expect(decoded_instruction.operands[3].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[3].index == 62u,
              "expected DS_MSKOR_RTN_B64 value VGPR") ||
      !Expect(decoded_instruction.operands[4].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[4].imm32 == 0x3cu,
              "expected DS_MSKOR_RTN_B64 offset0") ||
      !Expect(decoded_instruction.operands[5].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[5].imm32 == 0u,
              "expected DS_MSKOR_RTN_B64 offset1")) {
    return 1;
  }

  const auto ds_mskor_b64_words = MakeDs(76u, 59u, 60u, 61u, 62u, 0x3du);
  if (!Expect(decoder.DecodeInstruction(
                  std::span<const std::uint32_t>(ds_mskor_b64_words.data(),
                                                 ds_mskor_b64_words.size()),
                  &decoded_instruction, &words_consumed, &error_message),
              "expected DS_MSKOR_B64 decode success") ||
      !Expect(words_consumed == 2u,
              "expected DS_MSKOR_B64 two dwords consumed") ||
      !Expect(decoded_instruction.opcode == "DS_MSKOR_B64",
              "expected DS_MSKOR_B64 opcode") ||
      !Expect(decoded_instruction.operand_count == 5u,
              "expected DS_MSKOR_B64 five-operand decode") ||
      !Expect(decoded_instruction.operands[0].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[0].index == 60u,
              "expected DS_MSKOR_B64 address VGPR") ||
      !Expect(decoded_instruction.operands[1].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[1].index == 61u,
              "expected DS_MSKOR_B64 mask VGPR") ||
      !Expect(decoded_instruction.operands[2].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[2].index == 62u,
              "expected DS_MSKOR_B64 value VGPR") ||
      !Expect(decoded_instruction.operands[3].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[3].imm32 == 0x3du,
              "expected DS_MSKOR_B64 offset0") ||
      !Expect(decoded_instruction.operands[4].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[4].imm32 == 0u,
              "expected DS_MSKOR_B64 offset1")) {
    return 1;
  }
  ...
  if (!Expect(decoder.DecodeInstruction(
                  std::span<const std::uint32_t>(ds_sub_clamp_u32_words.data(),
                                                 ds_sub_clamp_u32_words.size()),
                  &decoded_instruction, &words_consumed, &error_message),
              "expected DS_SUB_CLAMP_U32 decode success") ||
      !Expect(words_consumed == 2u,
              "expected DS_SUB_CLAMP_U32 two dwords consumed") ||
      !Expect(decoded_instruction.opcode == "DS_SUB_CLAMP_U32",
              "expected DS_SUB_CLAMP_U32 opcode") ||
      !Expect(decoded_instruction.operand_count == 4u,
              "expected DS_SUB_CLAMP_U32 four-operand decode") ||
      !Expect(decoded_instruction.operands[0].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[0].index == 60u,
              "expected DS_SUB_CLAMP_U32 address VGPR") ||
      !Expect(decoded_instruction.operands[1].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[1].index == 61u,
              "expected DS_SUB_CLAMP_U32 data VGPR") ||
      !Expect(decoded_instruction.operands[2].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[2].imm32 == 0x3au,
              "expected DS_SUB_CLAMP_U32 offset0") ||
      !Expect(decoded_instruction.operands[3].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[3].imm32 == 0u,
              "expected DS_SUB_CLAMP_U32 offset1")) {
    return 1;
  }
  ...
  const auto ds_max_num_rtn_f32_words =
      MakeDs(51u, 59u, 60u, 61u, 62u, 0x3du);
  if (!Expect(decoder.DecodeInstruction(
                  std::span<const std::uint32_t>(
                      ds_max_num_rtn_f32_words.data(),
                      ds_max_num_rtn_f32_words.size()),
                  &decoded_instruction, &words_consumed, &error_message),
              "expected DS_MAX_NUM_RTN_F32 decode success") ||
      !Expect(words_consumed == 2u,
              "expected DS_MAX_NUM_RTN_F32 two dwords consumed") ||
      !Expect(decoded_instruction.opcode == "DS_MAX_NUM_RTN_F32",
              "expected DS_MAX_NUM_RTN_F32 opcode") ||
      !Expect(decoded_instruction.operand_count == 5u,
              "expected DS_MAX_NUM_RTN_F32 five-operand decode") ||
      !Expect(decoded_instruction.operands[0].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[0].index == 59u,
              "expected DS_MAX_NUM_RTN_F32 destination VGPR") ||
      !Expect(decoded_instruction.operands[1].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[1].index == 60u,
              "expected DS_MAX_NUM_RTN_F32 address VGPR") ||
      !Expect(decoded_instruction.operands[2].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[2].index == 61u,
              "expected DS_MAX_NUM_RTN_F32 data VGPR") ||
      !Expect(decoded_instruction.operands[3].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[3].imm32 == 0x3du,
              "expected DS_MAX_NUM_RTN_F32 offset0") ||
      !Expect(decoded_instruction.operands[4].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[4].imm32 == 0u,
              "expected DS_MAX_NUM_RTN_F32 offset1")) {
    return 1;
  }

  const auto ds_min_num_f32_words = MakeDs(18u, 59u, 60u, 61u, 62u, 0x3eu);
  if (!Expect(decoder.DecodeInstruction(
                  std::span<const std::uint32_t>(ds_min_num_f32_words.data(),
                                                 ds_min_num_f32_words.size()),
                  &decoded_instruction, &words_consumed, &error_message),
              "expected DS_MIN_NUM_F32 decode success") ||
      !Expect(words_consumed == 2u,
              "expected DS_MIN_NUM_F32 two dwords consumed") ||
      !Expect(decoded_instruction.opcode == "DS_MIN_NUM_F32",
              "expected DS_MIN_NUM_F32 opcode") ||
      !Expect(decoded_instruction.operand_count == 4u,
              "expected DS_MIN_NUM_F32 four-operand decode") ||
      !Expect(decoded_instruction.operands[0].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[0].index == 60u,
              "expected DS_MIN_NUM_F32 address VGPR") ||
      !Expect(decoded_instruction.operands[1].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[1].index == 61u,
              "expected DS_MIN_NUM_F32 data VGPR") ||
      !Expect(decoded_instruction.operands[2].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[2].imm32 == 0x3eu,
              "expected DS_MIN_NUM_F32 offset0") ||
      !Expect(decoded_instruction.operands[3].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[3].imm32 == 0u,
              "expected DS_MIN_NUM_F32 offset1")) {
    return 1;
  }

  const auto ds_max_num_rtn_f64_words =
      MakeDs(115u, 59u, 60u, 61u, 62u, 0x3fu);
  if (!Expect(decoder.DecodeInstruction(
                  std::span<const std::uint32_t>(
                      ds_max_num_rtn_f64_words.data(),
                      ds_max_num_rtn_f64_words.size()),
                  &decoded_instruction, &words_consumed, &error_message),
              "expected DS_MAX_NUM_RTN_F64 decode success") ||
      !Expect(words_consumed == 2u,
              "expected DS_MAX_NUM_RTN_F64 two dwords consumed") ||
      !Expect(decoded_instruction.opcode == "DS_MAX_NUM_RTN_F64",
              "expected DS_MAX_NUM_RTN_F64 opcode") ||
      !Expect(decoded_instruction.operand_count == 5u,
              "expected DS_MAX_NUM_RTN_F64 five-operand decode") ||
      !Expect(decoded_instruction.operands[0].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[0].index == 59u,
              "expected DS_MAX_NUM_RTN_F64 destination VGPR") ||
      !Expect(decoded_instruction.operands[1].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[1].index == 60u,
              "expected DS_MAX_NUM_RTN_F64 address VGPR") ||
      !Expect(decoded_instruction.operands[2].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[2].index == 61u,
              "expected DS_MAX_NUM_RTN_F64 data VGPR") ||
      !Expect(decoded_instruction.operands[3].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[3].imm32 == 0x3fu,
              "expected DS_MAX_NUM_RTN_F64 offset0") ||
      !Expect(decoded_instruction.operands[4].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[4].imm32 == 0u,
              "expected DS_MAX_NUM_RTN_F64 offset1")) {
    return 1;
  }

  const auto ds_min_num_f64_words = MakeDs(82u, 59u, 60u, 61u, 62u, 0x40u);
  if (!Expect(decoder.DecodeInstruction(
                  std::span<const std::uint32_t>(ds_min_num_f64_words.data(),
                                                 ds_min_num_f64_words.size()),
                  &decoded_instruction, &words_consumed, &error_message),
              "expected DS_MIN_NUM_F64 decode success") ||
      !Expect(words_consumed == 2u,
              "expected DS_MIN_NUM_F64 two dwords consumed") ||
      !Expect(decoded_instruction.opcode == "DS_MIN_NUM_F64",
              "expected DS_MIN_NUM_F64 opcode") ||
      !Expect(decoded_instruction.operand_count == 4u,
              "expected DS_MIN_NUM_F64 four-operand decode") ||
      !Expect(decoded_instruction.operands[0].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[0].index == 60u,
              "expected DS_MIN_NUM_F64 address VGPR") ||
      !Expect(decoded_instruction.operands[1].kind == OperandKind::kVgpr &&
                  decoded_instruction.operands[1].index == 61u,
              "expected DS_MIN_NUM_F64 data VGPR") ||
      !Expect(decoded_instruction.operands[2].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[2].imm32 == 0x40u,
              "expected DS_MIN_NUM_F64 offset0") ||
      !Expect(decoded_instruction.operands[3].kind == OperandKind::kImm32 &&
                  decoded_instruction.operands[3].imm32 == 0u,
              "expected DS_MIN_NUM_F64 offset1")) {
    return 1;
  }
  ...
  constexpr std::array<std::pair<std::string_view, std::uint32_t>, 12>
      kDsReturnU64DecodeCases{{
          {"DS_ADD_RTN_U64", 96u},
          {"DS_SUB_RTN_U64", 97u},
          {"DS_RSUB_RTN_U64", 98u},
          {"DS_INC_RTN_U64", 99u},
  ...
  for (std::size_t i = 0; i < kDsReturnU64DecodeCases.size(); ++i) {
    const auto ds_return_u64_words =
        MakeDs(kDsReturnU64DecodeCases[i].second, 59u, 60u, 61u, 62u,
               0x42u + static_cast<std::uint32_t>(i));
    if (!Expect(decoder.DecodeInstruction(
                    std::span<const std::uint32_t>(
                        ds_return_u64_words.data(),
                        ds_return_u64_words.size()),
                    &decoded_instruction, &words_consumed, &error_message),
                "expected DS return U64 decode success") ||
        !Expect(words_consumed == 2u,
                "expected DS return U64 two dwords consumed") ||
        !Expect(decoded_instruction.opcode == kDsReturnU64DecodeCases[i].first,
                "expected DS return U64 opcode") ||
        !Expect(decoded_instruction.operand_count == 5u,
                "expected DS return U64 five-operand decode") ||
        !Expect(decoded_instruction.operands[0].kind == OperandKind::kVgpr &&
                    decoded_instruction.operands[0].index == 59u,
                "expected DS return U64 destination VGPR") ||
        !Expect(decoded_instruction.operands[1].kind == OperandKind::kVgpr &&
                    decoded_instruction.operands[1].index == 60u,
                "expected DS return U64 address VGPR") ||
        !Expect(decoded_instruction.operands[2].kind == OperandKind::kVgpr &&
                    decoded_instruction.operands[2].index == 61u,
                "expected DS return U64 data VGPR") ||
        !Expect(decoded_instruction.operands[3].kind == OperandKind::kImm32 &&
                    decoded_instruction.operands[3].imm32 ==
                        0x42u + static_cast<std::uint32_t>(i),
                "expected DS return U64 offset0") ||
        !Expect(decoded_instruction.operands[4].kind == OperandKind::kImm32 &&
                    decoded_instruction.operands[4].imm32 == 0u,
                "expected DS return U64 offset1")) {
      return 1;
    }
  }
  ...
  if (!Expect(interpreter.ExecutableSeedOpcodes().size() == 517u,
      ...
      !Expect(interpreter.Supports("DS_MSKOR_RTN_B64"),
              "expected interpreter support for DS_MSKOR_RTN_B64") ||
      !Expect(interpreter.Supports("DS_MSKOR_B64"),
              "expected interpreter support for DS_MSKOR_B64") ||
      ...
      !Expect(interpreter.Supports("DS_COND_SUB_U32"),
              "expected interpreter support for DS_COND_SUB_U32") ||
      !Expect(interpreter.Supports("DS_SUB_CLAMP_RTN_U32"),
      ...
      !Expect(interpreter.Supports("DS_MIN_NUM_RTN_F32"),
              "expected interpreter support for DS_MIN_NUM_RTN_F32") ||
      !Expect(interpreter.Supports("DS_MIN_NUM_F32"),
              "expected interpreter support for DS_MIN_NUM_F32") ||
      !Expect(interpreter.Supports("DS_MAX_NUM_RTN_F32"),
              "expected interpreter support for DS_MAX_NUM_RTN_F32") ||
      !Expect(interpreter.Supports("DS_MAX_NUM_F32"),
              "expected interpreter support for DS_MAX_NUM_F32") ||
      !Expect(interpreter.Supports("DS_MIN_NUM_RTN_F64"),
              "expected interpreter support for DS_MIN_NUM_RTN_F64") ||
      !Expect(interpreter.Supports("DS_MIN_NUM_F64"),
              "expected interpreter support for DS_MIN_NUM_F64") ||
      !Expect(interpreter.Supports("DS_MAX_NUM_RTN_F64"),
      ...
      !Expect(interpreter.Supports("DS_ADD_RTN_U64"),
              "expected interpreter support for DS_ADD_RTN_U64") ||
      !Expect(interpreter.Supports("DS_SUB_RTN_U64"),
              "expected interpreter support for DS_SUB_RTN_U64") ||
      !Expect(interpreter.Supports("DS_RSUB_RTN_U64"),
              "expected interpreter support for DS_RSUB_RTN_U64") ||
      !Expect(interpreter.Supports("DS_INC_RTN_U64"),
              "expected interpreter support for DS_INC_RTN_U64") ||
      !Expect(interpreter.Supports("DS_DEC_RTN_U64"),
              "expected interpreter support for DS_DEC_RTN_U64") ||
      !Expect(interpreter.Supports("DS_MIN_RTN_I64"),
              "expected interpreter support for DS_MIN_RTN_I64") ||
      !Expect(interpreter.Supports("DS_MIN_RTN_U64"),
              "expected interpreter support for DS_MIN_RTN_U64") ||
      !Expect(interpreter.Supports("DS_MAX_RTN_I64"),
              "expected interpreter support for DS_MAX_RTN_I64") ||
      !Expect(interpreter.Supports("DS_MAX_RTN_U64"),
              "expected interpreter support for DS_MAX_RTN_U64") ||
      !Expect(interpreter.Supports("DS_AND_RTN_B64"),
              "expected interpreter support for DS_AND_RTN_B64") ||
      !Expect(interpreter.Supports("DS_OR_RTN_B64"),
              "expected interpreter support for DS_OR_RTN_B64") ||
      !Expect(interpreter.Supports("DS_XOR_RTN_B64"),
      ...
      !Expect(interpreter.Supports("DS_LOAD_U8_D16"),
              "expected interpreter support for DS_LOAD_U8_D16") ||
      !Expect(interpreter.Supports("DS_LOAD_U8_D16_HI"),
              "expected interpreter support for DS_LOAD_U8_D16_HI") ||
      !Expect(interpreter.Supports("DS_LOAD_I8_D16"),
              "expected interpreter support for DS_LOAD_I8_D16") ||
      !Expect(interpreter.Supports("DS_LOAD_I8_D16_HI"),
              "expected interpreter support for DS_LOAD_I8_D16_HI") ||
      !Expect(interpreter.Supports("DS_LOAD_U16_D16"),
              "expected interpreter support for DS_LOAD_U16_D16") ||
      !Expect(interpreter.Supports("DS_LOAD_U16_D16_HI"),
              "expected interpreter support for DS_LOAD_U16_D16_HI") ||
      ...
      !Expect(interpreter.Supports("DS_STORE_B8_D16_HI"),
