...
# REQUIRE_THREADS
#
# Require linking against Threads. Default is OFF.
#
# If set to ON, include Threads when building. This is required when
...
install(FILES
  "LICENSE.txt"
  DESTINATION ${CMAKE_INSTALL_DATADIR}/doc/amd-dbgapi
  COMPONENT dev)

install(FILES
  "LICENSE.txt"
  DESTINATION ${CMAKE_INSTALL_DATADIR}/doc/amd-dbgapi-asan
  COMPONENT asan)
