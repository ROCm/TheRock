...
export ROCR_MACOS_DIRECT_QUEUE_DEQUEUE_AFTER_SUBMIT="${ROCR_MACOS_DIRECT_QUEUE_DEQUEUE_AFTER_SUBMIT:-0}"
...
export ROCR_MACOS_DIRECT_QUEUE_ROTATE_BACKING_AFTER_DEQUEUE="${ROCR_MACOS_DIRECT_QUEUE_ROTATE_BACKING_AFTER_DEQUEUE:-0}"
