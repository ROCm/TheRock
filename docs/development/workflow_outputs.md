...
root.native_linux_packages(pkg_type="deb")   # {run_id}-linux/packages/deb — APT repo root
root.native_linux_packages(pkg_type="rpm")   # {run_id}-linux/packages/rpm — DNF/Zypper repo root
