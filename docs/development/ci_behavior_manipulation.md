...
| `ci:run-all-archs` | Build and test all possible architectures. Also enables ASAN CI (see below).                                                                                                                      |
| `ci:asan`          | Enable ASAN CI builds and tests. ASAN CI is skipped by default on PRs unless this label (or `ci:run-all-archs`) is present.                                                                       |
