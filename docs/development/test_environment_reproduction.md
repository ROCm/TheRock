...
- ADDITIONAL FLAGS (optional) are found in [installing_artifacts.md](https://github.com/ROCm/TheRock/blob/085571a87f8050f94c77eb90454995b6d1b75658/docs/development/installing_artifacts.md#source-options)
  - During CI runs, all components use flags to install specific artifacts (and avoid installing everything). Refer to the CI logs to see what flags are used
