...
- In CMake, take care when loading environment variables into strings and treating them as paths. Use https://cmake.org/cmake/help/latest/command/cmake_path.html, like `file(TO_CMAKE_PATH "$ENV{HIP_PATH}" HIP_PATH)`
