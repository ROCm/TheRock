...
if(WIN32)
  ...
  set(_llvm_enable_projects "clang;lld;clang-tools-extra")
  set(_llvm_enable_runtimes "compiler-rt;libunwind;libcxx;libcxxabi")
  if(THEROCK_ENABLE_FLANG)
    list(APPEND _llvm_enable_projects "flang")
    list(APPEND _llvm_enable_runtimes "openmp" "offload")
  endif()
  set(LLVM_ENABLE_PROJECTS "${_llvm_enable_projects}" CACHE STRING "Enable LLVM projects" FORCE)
  set(LLVM_ENABLE_RUNTIMES "${_llvm_enable_runtimes}" CACHE STRING "Enabled runtimes" FORCE)
  if("offload" IN_LIST LLVM_ENABLE_RUNTIMES)
    ...
    if(THEROCK_ENABLE_FLANG AND EXISTS "${THEROCK_SOURCE_DIR}/compiler/amd-llvm/openmp/device/CMakeLists.txt")
