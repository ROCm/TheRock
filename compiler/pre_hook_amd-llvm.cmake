...
if(WIN32)
  ...
  if("offload" IN_LIST LLVM_ENABLE_RUNTIMES)
    ...
    if(EXISTS "${THEROCK_SOURCE_DIR}/compiler/amd-llvm/openmp/device/CMakeLists.txt")
      ...
      set(LIBOMP_HWLOC_LIBRARY "hwloc" CACHE FILEPATH "" FORCE)
      cmake_path(GET HWLOC_INCLUDE_DIRS PARENT_PATH _hwloc_install_dir)
      set(LIBOMP_HWLOC_INSTALL_DIR "${_hwloc_install_dir}")
    endif()
  endif()
