...
if(THEROCK_BUILD_LLVM_TESTS)
  ...
  set(LLVM_BUILD_TESTS ON CACHE BOOL "Build LLVM unit test binaries" FORCE)
  set(LLVM_BUILD_EXAMPLES ON CACHE BOOL "Build LLVM examples for testing" FORCE)
  set(LLVM_EXAMPLES_INSTALL_DIR "bin" CACHE STRING "Install examples alongside tools" FORCE)
  set(CLANG_BUILD_EXAMPLES ON CACHE BOOL "Build Clang examples for testing" FORCE)
else()
...
if(THEROCK_BUILD_LLVM_TESTS OR THEROCK_BUILD_LLVM_TOOLS OR THEROCK_BUILD_COMGR_TESTS)
  ...
  # On Windows, llvm-lit is generated as llvm-lit.py (+ llvm-lit.cmd wrapper).
  if(WIN32)
    install(PROGRAMS "${CMAKE_CURRENT_BINARY_DIR}/bin/llvm-lit.py" DESTINATION bin)
    install(PROGRAMS "${CMAKE_CURRENT_BINARY_DIR}/bin/llvm-lit.cmd" DESTINATION bin)
  else()
