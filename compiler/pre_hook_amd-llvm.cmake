...
if(WIN32)
  ...
  if(THEROCK_ENABLE_FLANG_SUPPORT)
  ...
  if("offload" IN_LIST LLVM_ENABLE_RUNTIMES)
    ...
    if(THEROCK_ENABLE_FLANG_SUPPORT)
      ...
      set(OFFLOAD_ENABLE_EMISSARY_APIS ON)
    else()
      set(LIBOMPTARGET_BUILD_DEVICE_FORTRT OFF)
      set(OFFLOAD_ENABLE_EMISSARY_APIS OFF)
    endif()
    ...
    if(EXISTS "${THEROCK_SOURCE_DIR}/compiler/amd-llvm/openmp/device/CMakeLists.txt" AND THEROCK_ENABLE_FLANG_SUPPORT)
