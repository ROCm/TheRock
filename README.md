...
1. `python build_tools/setup_venv.py --index-name nightly --index-subdir gfx110-all --packages rocm .tmpvenv`
...
```bash
cmake -B build -GNinja . -DTHEROCK_AMDGPU_FAMILIES=gfx110-all
cmake --build build
```
