...
pip install --index-url https://nightly.repo.amd.com/rocm/whl-next/ \
  "torch[device-gfx942]"
pip install --extra-index-url https://nightly.repo.amd.com/rocm/whl-next/ \
...
or called from another workflow. Publishing is intentionally deferred until
UCCL has an agreed product bucket in the current `repo.amd.com` layout.
