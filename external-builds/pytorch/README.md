...
<!-- TODO: update this support table once we publish 2.8 and 2.9 stable for Linux and Windows -->

<!-- Check with https://github.com/ROCm/pytorch/pull/2686 which backports to 2.8 (might work on Windows?) -->
