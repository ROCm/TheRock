...
# macOS uses remote HIP execution model (no local GPU driver)
...
# THEROCK_CONDITION_HAS_LOCAL_GPU
# True only on platforms with local GPU driver support
set(THEROCK_CONDITION_HAS_LOCAL_GPU OFF)
if(THEROCK_CONDITION_IS_LINUX)
  set(THEROCK_CONDITION_HAS_LOCAL_GPU ON)
endif()

# THEROCK_CONDITION_USES_REMOTE_HIP
# True on platforms that use remote HIP execution
set(THEROCK_CONDITION_USES_REMOTE_HIP OFF)
if(THEROCK_CONDITION_IS_MACOS)
  set(THEROCK_CONDITION_USES_REMOTE_HIP ON)
endif()
