...
function(therock_cmake_subproject_declare target_name)
  ...
  foreach(_dep IN LISTS ARG_BUILD_DEPS ARG_RUNTIME_DEPS)
    get_target_property(_subproject_declared ${_dep} THEROCK_SUBPROJECT)
...
function(therock_cmake_subproject_provide_package target_name package_name relative_path)
  get_target_property(_subproject "${target_name}" THEROCK_SUBPROJECT)
  if(_subproject STREQUAL "cmake-off")
    return()
  endif()
