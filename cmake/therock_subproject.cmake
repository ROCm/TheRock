...
function(_therock_cmake_subproject_setup_toolchain
  ...
  # For cross-compilation (e.g., 32-bit builds), the compiler may be explicitly
  # set via CMAKE_ARGS, so only set defaults if not already provided.
  string(APPEND _toolchain_contents "if(NOT DEFINED CMAKE_C_COMPILER)\n")
  string(APPEND _toolchain_contents "  set(CMAKE_C_COMPILER \"@CMAKE_C_COMPILER@\")\n")
  string(APPEND _toolchain_contents "endif()\n")
  string(APPEND _toolchain_contents "if(NOT DEFINED CMAKE_CXX_COMPILER)\n")
  string(APPEND _toolchain_contents "  set(CMAKE_CXX_COMPILER \"@CMAKE_CXX_COMPILER@\")\n")
  string(APPEND _toolchain_contents "endif()\n")
  string(APPEND _toolchain_contents "if(NOT DEFINED CMAKE_LINKER)\n")
  string(APPEND _toolchain_contents "  set(CMAKE_LINKER \"@CMAKE_LINKER@\")\n")
  string(APPEND _toolchain_contents "endif()\n")
  if(WIN32)
    string(APPEND _toolchain_contents "if(NOT DEFINED CMAKE_RC_COMPILER)\n")
    string(APPEND _toolchain_contents "  set(CMAKE_RC_COMPILER \"@CMAKE_RC_COMPILER@\")\n")
    string(APPEND _toolchain_contents "endif()\n")
    string(APPEND _toolchain_contents "if(NOT DEFINED CMAKE_MT)\n")
