...
function(therock_cmake_subproject_build_test_finalize)
  ...
  string(APPEND _summary_content "set(_group_index 0)\n\n")

  foreach(_result_file IN LISTS _result_files)
    string(APPEND _summary_content "if(EXISTS \"${_result_file}\")\n")
    string(APPEND _summary_content "  if(_group_index GREATER 0)\n")
    string(APPEND _summary_content "    list(APPEND _summary_lines \"\")\n")
    ...
    string(APPEND _summary_content "  math(EXPR _group_index \"\${_group_index} + 1\")\n")
    string(APPEND _summary_content "endif()\n\n")
  endforeach()
