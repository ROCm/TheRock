...
macro(therock_dependency_provider method package_name)
  ...
  if("${package_name}" IN_LIST THEROCK_PROVIDED_PACKAGES AND NOT
    ...
    if("${package_name}" IN_LIST THEROCK_STRICT_PROVIDED_PACKAGES)
      cmake_policy(POP)
      message(FATAL_ERROR "Project contains find_package(${package_name}) for a package available in the super-project but not declared: Add a BUILD_DEPS or RUNTIME_DEPS appropriately")
    endif()
    cmake_policy(POP)
