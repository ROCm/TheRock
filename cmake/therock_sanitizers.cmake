function(therock_sanitizer_configure
  ...
  if(_sanitizer STREQUAL "ASAN")
    ...
    string(APPEND _stanza "add_compile_options($<$<AND:$<COMPILE_LANGUAGE:Fortran>,$<Fortran_COMPILER_ID:Flang>>:-fsanitize=address -fno-omit-frame-pointer -g>)\n")
    ...
    set(_fortran_and_flang_check "$<AND:$<LINK_LANGUAGE:Fortran>,$<Fortran_COMPILER_ID:Flang>>")
