...
class FunctionalBase:
    ...
    def rocm_path(self) -> Path:
        """ROCm installation path with CI and local fallbacks."""
        ...
        if hipcc_in_path:
            ...
            # Typical layouts:
            #   /opt/rocm/bin/hipcc      -> rocm root: /opt/rocm
            #   /opt/rocm/hip/bin/hipcc  -> rocm root: /opt/rocm
        ...
        # Last-resort default used on many ROCm systems.
